...
| State-Machine V2 (Schritt 1-8, Fall 1-4, Live-Auto-Loop via `CronCreate`/`CronDelete`) | Arbeit an `tradingMachine.ts`/`dealingRangeLoop.ts`/`tradingMachineGraph.js`/`TradingFlow.vue`, oder Fragen zur Auto-Loop-/Cron-Mechanik der State-Machine | [`docs/state-machine.md`](../../../docs/state-machine.md) |
