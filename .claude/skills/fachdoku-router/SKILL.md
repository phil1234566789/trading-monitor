...
|---|---|---|
| MCP-Server (Tools, Auth, Pin, Trade-Journal-Write-Tools, Candle-Archiv, Backfill-Scripts) | Arbeit an `mcp-server/` oder `supabase/functions/trading-monitor-mcp/` | [`docs/mcp-server.md`](../../../docs/mcp-server.md) |
