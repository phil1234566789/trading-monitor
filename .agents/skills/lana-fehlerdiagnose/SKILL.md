...
4. **Aus der bestätigten Diagnose den gezielten, STRUKTURELLEN Fix ableiten** — deckt sich mit der
   bestehenden AGENTS.md-Regel "Korrekturen — Doku/Regel fixen, nicht nur den Output": ein reiner
...
| Steerability, Regel-Konflikt/zu "leise" | `AGENTS.md`/`l.md`-Regel schärfen oder Reihenfolge/Gewichtung klarstellen |
