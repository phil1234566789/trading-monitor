...
| Aufmerksamkeits-Level (Watch-Level-Granularität je Fall 1-4, M5 vs. 1H/4H, "neuer OB"-Ping) | Arbeit an `computeWatchLevels()`/`fallClassifier.ts`/den Watch-Level-Feldern in `dealingRangeLoop.ts`, oder Fragen dazu, wann Lana bei einem Backtest/Live-Loop geweckt werden soll | [`docs/attention-levels.md`](../../../docs/attention-levels.md) |
