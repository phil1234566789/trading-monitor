...
// liquidity_levels/trade_setups/signals/trade_targets/trade_partial_exits/news_events/
// trading_schedules) bzw. select+insert (claude_annotations) nach demselben Single-User-Modell wie
// das restliche Repo (siehe CLAUDE.md).
