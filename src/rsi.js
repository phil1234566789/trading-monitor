...
// JSDoc-Typen hier nicht nur Doku — ohne sie leitet TS' allowJs-Inferenz für den MCP-Server-eigenen
// tools/reads.ts' cross-directory Import (siehe CLAUDE.md "MCP-Server") einen zu unscharfen Rückgabetyp
