...
// (pinContext.js embedded ob_zones direkt in fetchPinContext, da es dafür in Dashboard.vue
...
<template>
  <div v-if="rows.length === 0" class="pin-panel-empty">
  ...
  <div v-else class="pin-panel-list">
    <div v-for="row in rows" :key="row.entry.id" class="pin-panel-entry">
      ...
      <template v-else-if="row.entry.kind === 'trade_setup'">
        ...
        <div v-if="row.entry.tradeSetup" class="pin-panel-entry-prices">
      ...
      <template v-else-if="row.entry.kind === 'trade_confirmation'">
        ...
        <div v-if="row.entry.tradeConfirmation" class="pin-panel-entry-prices">
      ...
      <template v-else-if="row.entry.kind === 'm5_liquidity_level'">
        ...
        <div v-if="row.entry.m5Liquidity" class="pin-panel-entry-prices">
      ...
      <template v-else-if="row.entry.kind === 'rsi_divergence'">
        ...
        <div v-if="row.entry.rsiDivergence" class="pin-panel-entry-prices">
      ...
      <template v-else-if="row.trade">
        ...
        <div class="pin-panel-entry-prices">
      ...
      <div v-else class="pin-panel-entry-header">
