...
**Bedienungsanleitung (get_next_action/get_loop_state aufrufen, State lesen) steht separat in
[`state-machine-anleitung.md`](state-machine-anleitung.md).** Dieses Dokument hier ist technischer
Hintergrund/Architektur/Historie — relevant, wenn Code an der Maschine selbst geändert wird, nicht
zum Bedienen.
