...
## Corpus Check
- 543 files · ~557,083 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3224 nodes · 6526 edges · 169 communities (149 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1cc8fedf`
...
Cohesion: 0.02
Nodes (125): useSessionStorageRef(), useTabScopedRef(), addPositionToDealingRange(), antiConfluenceAddTrade, anyArmStateActive, ARM_STATES, closeTradeEditModal(), confirmationAddTrade (+117 more)
...
Cohesion: 0.17
Nodes (23): clearTradeSetupFocus(), clipReplay(), computeTradeSetupsInternal(), focusTradeSetup(), loadInitial(), loadTradeSetupM5(), measureClick(), measurePointAt() (+15 more)

### Community 4 - "PriceChart.vue"
Cohesion: 0.03
Nodes (77): nextCandlePollDelay(), activeMetadataSnapshot, allCandles, antiConfluencePickerCurrentPrice, antiConfluencePickerDivergenceCandidates, antiConfluencePickerHoveredLiquidityKey, antiConfluencePickerHoveredObKey, antiConfluencePickerInvalidationObCandidates (+69 more)
...
Cohesion: 0.09
Nodes (35): toPips(), postChartAnnotations(), buildServer(), MCP_TOKEN, berlinTwinKey(), json(), withBerlinTimes(), NEXT_ACTION_FALLBACK (+27 more)
...
### Community 12 - "chartTimeUtils.js"
Cohesion: 0.15
Nodes (15): computeNextReplayTime(), isTimeCovered(), mergeRecent(), nextCandleAfter(), replayFetchToMs(), snapToBarTime(), jumpToDivergence(), jumpToPin() (+7 more)
...
Cohesion: 0.06
Nodes (83): berlinDateStrFor(), berlinDateTimeStrFor(), berlinWeekdayAndMinutes(), isWithinTradingWindows(), buildPendingDecisions(), findIntermediateLevel(), FindIntermediateLevelArgs, IntermediateLevelCandidate (+75 more)
...
### Community 23 - "TradeMarkerPrimitive"
Cohesion: 0.14
...
Cohesion: 0.09
Nodes (24): emit, instrumentSessions, props, WEEKDAY_DISPLAY_ORDER, usePriceChartCockpit(), refreshCockpit(), usePriceChartSessionsAndNews(), refreshSessions() (+16 more)
...
Cohesion: 0.15
Nodes (24): emit, obZoneCtx(), onAntiConfluencePickerHover(), onAntiConfluencePickerSelect(), onTargetPickerHover(), onTargetPickerSelect(), refreshLiquidityInternal(), refreshPoiZonesInternal() (+16 more)
...
Cohesion: 0.10
Nodes (29): berlinDateStrFor(), addClaudeAnnotationDrawing(), fetchClaudeAnnotations(), removeClaudeAnnotationDrawing(), setClaudeAnnotationDrawingVisible(), applyText(), emit, error (+21 more)
...
Cohesion: 0.08
Nodes (37): cssColor(), cssColorScaled(), hexToRgba(), lineWidth(), tradesVisibleForCandles(), candidateLabel(), candidatePrice(), emit (+29 more)

### Community 52 - "findAntiConfluenceCandidates.js"
Cohesion: 0.07
Nodes (49): AgeTier, businessSecondsBetween(), classifyAge(), computeSweepAgeHours(), MAJOR_MIN_HOURS, MAJOR_MIN_SECONDS, MINOR_MAX_HOURS, MINOR_MAX_SECONDS (+41 more)
...
Cohesion: 0.16
Nodes (13): DB_READ_PAGE_SIZE, fetchAllRows(), ArchivableCandle, LIQUIDITY_FRACTAL_PERIOD, backfillOne(), BAR_CONFIG, BARS, CandleRow (+5 more)
...
Cohesion: 0.13
Nodes (15): berlinDayRangeUtcMs(), berlinOffsetMinutes(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, ANNOTATION_COLOR, annotationAnchorPoint(), AnnotationsRenderer (+7 more)
...
Cohesion: 0.20
Nodes (12): openTargetPicker(), candidateLabel(), emit, mergedCandidates, precision, props, DEFAULT_LIQUIDITY_TARGET_LIMIT, DEFAULT_OB_TARGET_LIMIT (+4 more)
...
Cohesion: 0.11
Nodes (19): { activeLabels, isActive }, isFresh, { lastSuccessAt }, lastUpdateText, now, showClaudeAnnotationsModal, statusDotClass, statusText (+11 more)
...
Cohesion: 0.08
Nodes (44): berlinDayRangeUtcMs(), isBoxInvalidated(), detectSetupObs(), findRecentTradeSetupIdsByKey(), getForexCandlesArchive(), getForexCandlesArchiveUpTo(), getJournal(), getNewsEvents() (+36 more)
...
Cohesion: 0.08
Nodes (55): berlinOffsetMinutes(), filterRelevantLevels(), PIP_SIZE, ALL_DAYS, attachRangeExtremes(), bonusLabelForPivot(), buildSessionContextLookup(), contextForPivot() (+47 more)
...
Cohesion: 0.08
Nodes (26): buildActiveMetadataSnapshotInternal(), emit, OUTCOME_LABEL, precision, props, sortedDivergences, stats, emit (+18 more)
...
### Community 116 - "berlinTime.ts"
Cohesion: 0.23
Nodes (9): DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, berlinOffsetSuffix(), hasExplicitOffset(), missingOffsetError(), ISO_WITH_OFFSET, SOMMER_MS (+1 more)
...
### Community 134 - "tradeEvidence.ts"
Cohesion: 0.27
Nodes (9): confirmationLabel(), evidenceAgeSeconds(), evidenceAgeTier(), formatEvidenceLabel(), KIND_LABEL, kindLabel(), TradeEvidence, TradeEvidenceCategory (+1 more)
...
### Community 141 - "usePriceChartRsi"
Cohesion: 0.24
...
### Community 145 - "AnnotationsPrimitive"
Cohesion: 0.16
...
Cohesion: 0.31
Nodes (8): formatDatedTime(), formatPips(), MEASURE_COLOR, measureDrawing(), measureModeActive, riskPips, toPips(), onMeasureDone()

### Community 155 - "liquidityDetection.ts"
Cohesion: 0.17
...
### Community 163 - "MAX_TARGET_DISTANCE_PIPS Constant"
Cohesion: 0.50
...
## Knowledge Gaps
- **1170 isolated node(s):** `showClaudeAnnotationsModal`, `{ visible: claudeAnnotationsVisible }`, `{ lastSuccessAt }`, `{ activeLabels, isActive }`, `now` (+1165 more)
...
- **Why does `businessSecondsBetween()` connect `findAntiConfluenceCandidates.js` to `tradeSetup.ts`, `tradeTargets.ts`, `dataExport.ts`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `marketStructureAnalysis Developer Notes` connect `Vegapunk Slimming Results (-86%)` to `fachdoku-router/SKILL.md`, `marketStructureAnalysis Rules Overview`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `liquidity.js`, `usePriceChartMarketStructure.js`, `FibTickPrimitive`, `cssColor`, `Vegapunk Slimming Results (-86%)`, `src/marketStructureAnalysis.ts`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **What connects `showClaudeAnnotationsModal`, `{ visible: claudeAnnotationsVisible }`, `{ lastSuccessAt }` to the rest of the system?**
  _1170 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Dashboard.vue` be split into smaller, more focused modules?**
  _Cohesion score 0.015416238437821172 - nodes in this community are weakly interconnected._
