...
## Corpus Check
- 564 files · ~595,840 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3338 nodes · 6756 edges · 179 communities (159 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 115 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b4cbca59`
...
Cohesion: 0.01
Nodes (134): useSessionStorageRef(), useTabScopedRef(), addPositionToDealingRange(), antiConfluenceAddTrade, anyArmStateActive, ARM_HINTS, ARM_STATES, armedAction (+126 more)
...
### Community 3 - "berlinDateTimeStrFor"
Cohesion: 0.07
Nodes (48): berlinDateTimeStrFor(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, toPips(), dropLowerTfDuplicates(), filterRelevantRows(), getLiquidityLevels() (+40 more)

### Community 4 - "PriceChart.vue"
Cohesion: 0.03
Nodes (85): mergeRecent(), replayFetchToMs(), activeMetadataSnapshot, allCandles, antiConfluencePickerCurrentPrice, antiConfluencePickerDivergenceCandidates, antiConfluencePickerHoveredLiquidityKey, antiConfluencePickerHoveredObKey (+77 more)
...
### Community 7 - "nearRelevantLiquidityLevels.ts"
Cohesion: 0.24
Nodes (15): berlinOffsetMinutes(), ALL_DAYS, attachRangeExtremes(), bonusLabelForPivot(), buildSessionContextLookup(), contextForPivot(), daysOrAll(), localMidnightUtc() (+7 more)
...
### Community 12 - "findTargets.js"
Cohesion: 0.10
Nodes (23): HTF_FOREX_MIN_GAP_PIPS Constant, LOWER_TF_MIN_GAP_PIPS Constant, Pip-/Pixel-Schwellwerte Übersicht, MAX_TARGET_DISTANCE_PIPS Constant, PIP_SIZE Constant, RANGE_FIB_MIN_PP_DISTANCE_PIPS Constant, TRADE_SETUP_LS_MAX_DISTANCE_M5 Constant, find_targets Target-Candidate Algorithm Design (+15 more)
...
### Community 14 - "usePriceChartMarketStructure.js"
Cohesion: 0.16
Nodes (17): M5_STRUCTURE_STYLE_KEYS, usePriceChartMarketStructure(), computeRangesPivotsAndMetadata(), computeRangesPivotsFor(), refreshM5Structure(), refreshMarketStructure(), refreshRangesMarkers(), structureRenderOptions() (+9 more)

### Community 15 - "TradeEditModal.vue"
Cohesion: 0.06
Nodes (42): commission, emit, entryPrice, entryTimeInput, exitPrice, exitTimeInput, instrumentMismatch, invalidationItems (+34 more)
...
### Community 25 - "liveTouch.ts"
Cohesion: 0.39
Nodes (6): findLevelTouch(), findZoneTouch(), levelTouchPrice(), LIVE_TOUCH_WINDOW_SEC, recentCandles(), zoneTouchPrice()

### Community 26 - "tradeIntake.js"
Cohesion: 0.15
Nodes (24): addConfirmationToTrade(), addRangeConfirmation(), addTargetToTrade(), createDealingRange(), directionForSetup(), findMatchingTradeSetupId(), findOrCreateLiquidityLevelId(), insertConfirmation() (+16 more)
...
### Community 30 - "backfillForexCandles.ts"
Cohesion: 0.09
Nodes (20): DB_READ_PAGE_SIZE, fetchAllRows(), ArchivableCandle, ALL_BARS, backfillOne(), Bar, BARS, INSTRUMENTS (+12 more)
...
### Community 35 - "scaleRendering.js"
Cohesion: 0.19
...
### Community 37 - "TradeSetupCockpit.vue"
Cohesion: 0.08
Nodes (25): Plan: find_targets Algorithmus, TSC-Neuaufbau Precondition, emit, accentStyle, antiConfluences, canTransfer, confirmationLabel(), confirmations (+17 more)
...
### Community 41 - "validationEvidence.ts"
Cohesion: 0.16
...
Cohesion: 0.17
Nodes (13): fetchDailyStructurePivots(), DB_READ_PAGE_SIZE, fetchAllRows(), fetchLiquidityLevelsHtf(), fetchObZones(), fetchUntouchedZones(), fetchTouchedZones(), MAX_PROTOKOLL_ZEILEN (+5 more)

### Community 43 - "clipReplay"
Cohesion: 0.11
Nodes (36): tradesVisibleForCandles(), applyCandleData(), buildActiveMetadataSnapshotInternal(), clearTradeSetupFocus(), clipReplay(), computeTradeSetupsInternal(), focusTradeSetup(), jumpToDivergence() (+28 more)

### Community 44 - "trading-monitor-mcp/marketStructureAnalysis.ts"
Cohesion: 0.19
Nodes (25): advanceNestedTrend(), advanceNestedTrendInner(), applyInnerMarketStructurePivot(), applyInnerMarketStructurePivotCore(), applyMarketStructurePivot(), applyMarketStructurePivotCore(), buildMarketStructureState(), Candle (+17 more)
...
### Community 59 - "berlinDateStrFor"
Cohesion: 0.11
Nodes (41): berlinDateStrFor(), berlinDayRangeUtcMs(), buildPendingDecisions(), findIntermediateLevel(), FindIntermediateLevelArgs, IntermediateLevelCandidate, isSpreadHourPivot(), PendingDecision (+33 more)

### Community 60 - "db.ts"
Cohesion: 0.07
Nodes (50): addPinEntry(), addPinM5LiquidityEntry(), addPinM5ObEntry(), addPinRsiDivergenceEntry(), addTradeConfirmation(), AddTradeConfirmationArgs, addTradeTarget(), AddTradeTargetArgs (+42 more)

### Community 61 - "usePriceChartLiquidity.js"
Cohesion: 0.15
Nodes (21): usePriceChartLiquidity(), attachBonus(), refresh(), liquidityLevelNaturalKey(), renderLiquidityLevels(), filterRelevantLevels(), LIQUIDITY_FRACTAL_PERIOD, selectRelevantHtfLevels() (+13 more)

### Community 62 - "trades.ts"
Cohesion: 0.11
...
Cohesion: 0.08
Nodes (11): MIN_PIXELS_PER_HOUR_FOR_LABELS Constants, drawIconLabel(), canShowLabels(), MIN_PIXELS_PER_HOUR_FOR_LABELS, MIN_PIXELS_PER_HOUR_FOR_LABELS_INTRADAY, positionsBox(), ZoneRenderer, DivergenceLinePaneView (+3 more)
...
### Community 75 - "LiquidityLinePrimitive"
Cohesion: 0.22
Nodes (3): usePriceChartTradeSetupDrawing(), refresh(), LiquidityLinePrimitive
...
### Community 79 - "liquidityDetection.js"
Cohesion: 0.21
Nodes (8): buildLevel(), detectLiquidityLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_MAX_RELEVANT, ROOT, TEILPORTS, VOLL_KOPIEN
...
Cohesion: 0.12
Nodes (34): isBoxInvalidated(), detectSetupObs(), findRecentTradeSetupIdsByKey(), getForexCandlesArchive(), getForexCandlesArchiveUpTo(), getJournal(), getNewsEvents(), getTradeSetups() (+26 more)
...
Cohesion: 0.08
Nodes (40): formatDatedTime(), formatPips(), MEASURE_COLOR, measureDrawing(), tabelle, FVG_BAENDER, FVG_BAND_LABELS, FVG_BAND_N (+32 more)

### Community 92 - "marketStructureRendering.ts"
Cohesion: 0.28
Nodes (13): collectNestedChain(), collectFibLevels(), collectStructureLqLevels(), computeFibLevels(), fibBetween(), firstCloseBelow(), protectedLabel(), renderMarketStructureAnalysis() (+5 more)

### Community 93 - "dataExport.ts"
Cohesion: 0.16
Nodes (19): filterRelevantLevels(), getLatestDailyStructureStartTime(), computeRangesPivots(), pivotForDisplay(), summarizeMarketStructureState(), buildDataExport(), capStructurePivots(), coincidesWithHtf() (+11 more)
...
### Community 100 - "_shared/pipConfig.js"
Cohesion: 0.16
Nodes (13): CORS_HEADERS, ExistingPivotRow, INSTRUMENTS, PIP_SIZE, DailyPivotLike, resolveStructureStartTime(), getObZones(), buildNearRelevantObZones() (+5 more)
...
### Community 108 - "FibTickPrimitive"
Cohesion: 0.15
...
### Community 122 - "RangeLinePrimitive"
Cohesion: 0.18
...
### Community 133 - "snapToBarTime"
Cohesion: 0.12
Nodes (7): snapToBarTime(), Candle, PivotMarkerGroup, PivotMarkerPaneView, PivotMarkerPrimitive, PivotMarkerRenderer, RenderOptions

### Community 134 - "findAntiConfluenceCandidates.js"
Cohesion: 0.15
...
Cohesion: 0.16
Nodes (22): classifyAge(), MAJOR_MIN_SECONDS, MINOR_MAX_SECONDS, ageReferenceTime(), businessSecondsBetween(), formatAge(), targetLabel(), targetLabel() (+14 more)

### Community 141 - "format.js"
Cohesion: 0.14
...
### Community 148 - "Fachdoku-Router Skill"
Cohesion: 0.15
...
### Community 149 - "tradeEvidence.ts"
Cohesion: 0.19
Nodes (12): AgeTier, confirmationLabel(), invalidationLabel(), sweepTier, evidenceAgeSeconds(), evidenceAgeTier(), formatEvidenceLabel(), KIND_LABEL (+4 more)

### Community 153 - "findAntiConfluences.js"
Cohesion: 0.38
...
### Community 164 - "chartTimeUtils.test.js"
Cohesion: 0.40
Nodes (3): computeNextReplayTime(), nextCandleAfter(), nextReplayTime()

### Community 165 - "messeFxcmKontext.ts"
Cohesion: 0.32
Nodes (4): createAnalysisSnapshotFetch(), compressed, root, rows

### Community 166 - "findTargetCandidates.js"
Cohesion: 0.17
Nodes (15): buildCandidatePool(), DEFAULT_LIQUIDITY_TARGET_LIMIT, DEFAULT_OB_TARGET_LIMIT, findNearestLiquidityTargets(), findNearestObTargets(), findTargetCandidates(), isTooFarFromPrice(), MAX_TARGET_DISTANCE_PIPS (+7 more)

### Community 168 - "marketStructureAnalysisFib.test.js"
Cohesion: 0.33
...
### Community 170 - "Protokoll.vue"
Cohesion: 0.14
Nodes (14): fetchAlarmLog(), fetchTouchedLiquidityLevels(), fetchTradeSetups(), ALARM_TYPES, fetchAlarmSettings(), setAlarmEnabled(), router, alarms (+6 more)
...
### Community 175 - "cTrader Open API as Forex Candle Source"
Cohesion: 0.40
...
### Community 179 - "liquidityDetection.ts"
Cohesion: 0.18
Nodes (15): buildLevel(), detectLiquidityLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD, LIQUIDITY_MAX_RELEVANT, backfillOne(), BAR_CONFIG (+7 more)

### Community 180 - "fachdoku-router-reminder.cjs"
Cohesion: 0.40
Nodes (3): { join }, { readFileSync }, SKILL

### Community 182 - "orderBlocks.ts"
Cohesion: 0.20
Nodes (11): buildLevel(), detectLiquidityLevels(), isDownFractal(), isUpFractal(), Candle, detectOrderBlocks(), HTF_FOREX_LABELS, HTF_FOREX_MIN_GAP_PIPS (+3 more)
...
## Knowledge Gaps
- **1218 isolated node(s):** `{ readFileSync }`, `{ join }`, `SKILL`, `{ execFileSync }`, `path` (+1213 more)
...
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `lineWidth`, `liquidity.js`, `LiquidityLinePrimitive`, `cssColor`, `usePriceChartMarketStructure.js`, `FibTickPrimitive`, `Vegapunk Slimming Results (-86%)`, `RangeLinePrimitive`, `Pivot`?**
...
- **Should `Dashboard.vue` be split into smaller, more focused modules?**
  _Cohesion score 0.014524728810443097 - nodes in this community are weakly interconnected._
