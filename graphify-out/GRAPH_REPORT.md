...
## Corpus Check
- 526 files · ~517,619 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3175 nodes · 6439 edges · 158 communities (139 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ba107578`
...
Cohesion: 0.02
Nodes (118): useSessionStorageRef(), fetchDailyStructurePivots(), fetchLiquidityLevelsHtf(), antiConfluenceAddTrade, anyArmStateActive, ARM_STATES, closeTradeEditModal(), confirmationAddTrade (+110 more)
...
Cohesion: 0.09
Nodes (33): cachedCandlesUpTo(), cacheKey(), fetchCandlesCached(), getCachedCandles(), mergeCandles(), openDb(), safeCompleteUpTo(), setCachedCandles() (+25 more)
...
Cohesion: 0.15
Nodes (22): addTradePosition(), createTrade(), deleteTradeTarget(), getDealingRangeById(), insertTradePosition(), updateDealingRange(), updateTradeTarget(), findUnexplainedNearerTargets() (+14 more)
...
Cohesion: 0.06
Nodes (41): commission, emit, entryPrice, entryTimeInput, exitPrice, exitTimeInput, flashInvalidationSaved(), instrumentMismatch (+33 more)
...
### Community 19 - "db.ts"
Cohesion: 0.08
Nodes (49): berlinDateStrFor(), addPinEntry(), addPinM5LiquidityEntry(), addPinM5ObEntry(), addPinRsiDivergenceEntry(), addTradeConfirmation(), AddTradeConfirmationArgs, addTradeTarget() (+41 more)
...
Cohesion: 0.12
Nodes (18): PIP_SIZE, firstObFormationTimeAfter(), TriggerCandle, detectOrderBlocks(), HTF_FOREX_LABELS, HTF_FOREX_MIN_GAP_PIPS, LOWER_TF_LABELS, LOWER_TF_MIN_GAP_PIPS (+10 more)
...
Cohesion: 0.05
Nodes (49): cssColor(), cssColorScaled(), hexToRgba(), lineWidth(), tradesVisibleForCandles(), candidateLabel(), candidatePrice(), emit (+41 more)
...
Cohesion: 0.09
Nodes (25): onRemoveConfirmation(), onRemoveTarget(), pnlClass, props, stats, winrateClass, fmtR(), removeConfirmationFromTrade() (+17 more)

### Community 28 - "berlinDateTimeStrFor"
Cohesion: 0.09
Nodes (31): berlinDateTimeStrFor(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, updateTradePosition(), berlinTwinKey(), withBerlinTimes(), closeLoopState() (+23 more)
...
Cohesion: 0.18
Nodes (11): currentSessionDanger(), DANGER_SEVERITY, hexToRgba(), highLowInWindow(), isForbiddenAt(), renderSessions(), saveToRemote(), sessions (+3 more)
...
Cohesion: 0.09
Nodes (22): emit, emit, accentStyle, antiConfluences, canTransfer, confirmations, confluences, dateLabel (+14 more)
...
Cohesion: 0.08
Nodes (32): HTF_FOREX_MIN_GAP_PIPS Constant, LOWER_TF_MIN_GAP_PIPS Constant, Pip-/Pixel-Schwellwerte Übersicht, PIP_SIZE Constant, RANGE_FIB_MIN_PP_DISTANCE_PIPS Constant, TRADE_SETUP_LS_MAX_DISTANCE_M5 Constant, poi-watcher 4H+1H OB-Zonen-Wächter Edge Function, detectOrderBlocks() (+24 more)

### Community 42 - "alarmLog.js"
Cohesion: 0.18
Nodes (12): fetchAlarmLog(), fetchTouchedLiquidityLevels(), fetchTradeSetups(), usePolledFetch(), load(), lastSuccessAt, useStatusBar(), markSuccess() (+4 more)
...
### Community 51 - "biasCheck.ts"
Cohesion: 0.16
Nodes (24): TradingLoopStateRow, upsertBiasFields(), deriveStepAndCase(), LoadedMachine, loadMachineForDayOrNull(), loadOrCreateMachineForDay(), persistTransition(), rehydrateActor() (+16 more)
...
Cohesion: 0.04
Nodes (45): Definitionen, Die Filter, DR-Reichweite — was taugen die erkannten Setups?, Enge der DR — warum beide Einheiten nötig sind, find_targets, Gegenkraft — teilweise gekippt, Grenzen, Handelszeit — als Fenster tot, als Stunde lebendig (+37 more)
...
Cohesion: 0.05
Nodes (54): Two Runtimes, One Algorithm Set (Deliberate Duplication), ageReferenceTime(), businessSecondsBetween(), usePriceChartLiquidity(), attachBonus(), refresh(), computeTradeSetups(), ageSuffix() (+46 more)

### Community 62 - "findTargetCandidates.js"
Cohesion: 0.14
Nodes (18): compressed, root, rows, targets, trends, worker(), buildCandidatePool(), DEFAULT_LIQUIDITY_TARGET_LIMIT (+10 more)
...
Cohesion: 0.12
Nodes (15): ArchivableCandle, readForexCandlesArchiveFrom(), LiquidityLevel, DEFAULT_TRADE_SETUP_PARAMS, SetupSweep, TRADE_SETUP_H1_FRACTAL_PERIOD, TRADE_SETUP_M5_FRACTAL_PERIOD, persistTradeSetupSweeps() (+7 more)
...
### Community 82 - "liquidityDetection.ts"
Cohesion: 0.18
...
Cohesion: 0.11
Nodes (33): filterRelevantLevels(), dropLowerTfDuplicates(), filterRelevantRows(), getLatestDailyStructureStartTime(), getLiquidityLevels(), getObZones(), getSessions(), computeRangesPivots() (+25 more)
...
### Community 101 - "SessionsModal.vue"
Cohesion: 0.15
...
### Community 104 - "findAntiConfluenceCandidates.js"
Cohesion: 0.40
...
Cohesion: 0.16
Nodes (18): refreshMarketStructure(), bullBearLabelSide(), Candle, ArrowPrimitive, collectFibLevels(), collectH1LqLevels(), collectNestedChain(), computeFibLevels() (+10 more)
...
Cohesion: 0.20
Nodes (8): ALARM_TYPES, fetchObZones(), fetchUntouchedZones(), fetchStateMachineLog(), rowToDecision(), supabase, { data: dbObZones }, { from }
...
Cohesion: 0.25
Nodes (13): buildLevel(), detectLiquidityLevels(), isDownFractal(), isUpFractal(), LiquidityLevel, isBoxInvalidated(), DetectedTradeSetup, detectSetupObs() (+5 more)
...
### Community 157 - "addPositionToDealingRange"
Cohesion: 0.67
...
## Knowledge Gaps
- **1168 isolated node(s):** `{ execFileSync }`, `path`, `TRADING_REPO`, `{ execFileSync }`, `path` (+1163 more)
...
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `chartTimeUtils.js`, `FibTickPrimitive`, `Vegapunk Slimming Results (-86%)`, `cssColor`, `liquidity.js`?**
