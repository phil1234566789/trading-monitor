...
## Summary
- 3163 nodes · 6419 edges · 159 communities (137 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 106 edges (avg confidence: 0.85)
...
Cohesion: 0.09
Nodes (35): toPips(), createDealingRange(), deleteDealingRange(), fetchActiveTscRangeId(), postChartAnnotations(), buildServer(), MCP_TOKEN, berlinTwinKey() (+27 more)
...
Cohesion: 0.06
Nodes (40): trendChain, accentStyle, antiConfluences, canTransfer, confirmations, confluences, dateLabel, direction (+32 more)

### Community 12 - "berlinDateStrFor"
Cohesion: 0.09
Nodes (59): berlinDateStrFor(), berlinDateTimeStrFor(), berlinDayRangeUtcMs(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, getOpenOppositeDealingRanges(), getLoopStateForDay() (+51 more)
...
### Community 19 - "db.ts"
Cohesion: 0.06
Nodes (61): addPinEntry(), addPinM5LiquidityEntry(), addPinM5ObEntry(), addPinRsiDivergenceEntry(), addTradeConfirmation(), AddTradeConfirmationArgs, addTradePosition(), addTradeTarget() (+53 more)
...
Cohesion: 0.16
Nodes (6): drawIconLabel(), canShowLabels(), LiquidityLineRenderer, positionsBox(), DivergenceLineRenderer, mergePinnedDivergences()

### Community 29 - "router.js"
Cohesion: 0.24
...
Cohesion: 0.11
Nodes (19): HTF_FOREX_MIN_GAP_PIPS Constant, LOWER_TF_MIN_GAP_PIPS Constant, Pip-/Pixel-Schwellwerte Übersicht, MIN_PIXELS_PER_HOUR_FOR_LABELS Constants, PIP_SIZE Constant, RANGE_FIB_MIN_PP_DISTANCE_PIPS Constant, TRADE_SETUP_LS_MAX_DISTANCE_M5 Constant, poi-watcher 4H+1H OB-Zonen-Wächter Edge Function (+11 more)
...
Cohesion: 0.17
Nodes (19): asOfProbeCandles(), firstObFormationTimeAfter(), TriggerCandle, detectOrderBlocks(), applyAsOf(), applyAsOfZones(), earliestAmbiguousEventSec(), existsAsOf() (+11 more)
...
### Community 59 - "marketStructureAnalysisInnerPivots.test.js"
Cohesion: 0.25
...
### Community 66 - "marketStructureAnalysisFib.test.js"
Cohesion: 0.29
...
Cohesion: 0.11
Nodes (20): { activeLabels, isActive }, isFresh, { lastSuccessAt }, lastUpdateText, now, showClaudeAnnotationsModal, statusDotClass, statusText (+12 more)
...
Cohesion: 0.06
Nodes (71): berlinOffsetMinutes(), fetchAllRows(), filterRelevantLevels(), PIP_SIZE, ALL_DAYS, attachRangeExtremes(), bonusLabelForPivot(), buildSessionContextLookup() (+63 more)
...
Cohesion: 0.08
Nodes (20): cssColor(), cssColorScaled(), hexToRgba(), emit, lessonBadges(), OUTCOME_LABEL, props, rangeLabel() (+12 more)

### Community 96 - "MAX_TARGET_DISTANCE_PIPS Constant"
Cohesion: 0.50
...
Cohesion: 0.06
Nodes (22): Candle, ArrowPaneView, ArrowPrimitive, ArrowRenderer, collectFibLevels(), collectH1LqLevels(), collectNestedChain(), computeFibLevels() (+14 more)
...
### Community 108 - "src/pipConfig.js"
Cohesion: 0.31
...
### Community 116 - "chartTimeUtils.test.js"
Cohesion: 0.11
Nodes (19): computeNextReplayTime(), mergeRecent(), nextCandleAfter(), replayFetchToMs(), loadInitial(), loadRangesCandles(), m5ClockEnabled(), nextReplayTime() (+11 more)
...
Cohesion: 0.10
Nodes (37): AgeTier, classifyAge(), MAJOR_MIN_SECONDS, MINOR_MAX_SECONDS, ageReferenceTime(), businessSecondsBetween(), formatAge(), snapToBarTime() (+29 more)
...
### Community 154 - "berlinTime.js"
Cohesion: 0.21
Nodes (12): berlinDayRangeUtcMs(), berlinOffsetMinutes(), DATE_FORMATTER, formatDatedTime(), OFFSET_FORMATTER, TIME_FORMATTER, formatPips(), MEASURE_COLOR (+4 more)
