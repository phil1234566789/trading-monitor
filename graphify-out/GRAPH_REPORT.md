...
## Corpus Check
- 583 files · ~617,112 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3404 nodes · 6877 edges · 194 communities (166 shown, 20 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 122 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c97d249e`
...
Cohesion: 0.03
Nodes (77): PIP_SIZE Constant, TRADE_SETUP_LS_MAX_DISTANCE_M5 Constant, activeMetadataSnapshot, allCandles, antiConfluencePickerCurrentPrice, antiConfluencePickerDivergenceCandidates, antiConfluencePickerHoveredLiquidityKey, antiConfluencePickerHoveredObKey (+69 more)
...
Cohesion: 0.12
Nodes (32): tradesVisibleForCandles(), applyCandleData(), buildActiveMetadataSnapshotInternal(), clearTradeSetupFocus(), clipReplay(), computeTradeSetupsInternal(), focusTradeSetup(), loadInitial() (+24 more)
...
Cohesion: 0.22
Nodes (16): computeTradeSetups(), collectStructureLqLevels(), toLqLevel(), closesBeyondLevel(), collectObSweeps(), detectSetupObs(), detectTradeSetups(), findAllProtectedFractals() (+8 more)
...
Cohesion: 0.13
Nodes (34): berlinDateStrFor(), FallFourResult, WatchLevel, ForceAssessment, appendHeartbeat(), LoopLevel, updateLoopState(), loadMachineForDay() (+26 more)
...
Cohesion: 0.11
Nodes (31): emit, obZoneCtx(), onAntiConfluencePickerHover(), onAntiConfluencePickerSelect(), onTargetPickerHover(), onTargetPickerSelect(), refreshLiquidityInternal(), refreshPoiZonesInternal() (+23 more)
...
### Community 25 - "db.ts"
Cohesion: 0.07
Nodes (53): addPinEntry(), addPinM5LiquidityEntry(), addPinM5ObEntry(), addPinRsiDivergenceEntry(), addTradeConfirmation(), AddTradeConfirmationArgs, addTradeTarget(), AddTradeTargetArgs (+45 more)
...
Cohesion: 0.16
Nodes (17): buildLevel(), detectLiquidityLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD, LIQUIDITY_MAX_RELEVANT, DEFAULT_LIQUIDITY_TARGET_LIMIT, DEFAULT_OB_TARGET_LIMIT (+9 more)

### Community 31 - "sessions.js"
Cohesion: 0.21
Nodes (12): usePriceChartCockpit(), refreshCockpit(), newsEvents, currentSessionDanger(), DANGER_SEVERITY, hexToRgba(), highLowInWindow(), isForbiddenAt() (+4 more)
...
Cohesion: 0.06
Nodes (43): clampedX, clampedY, confirm(), emit, note, onKeydown(), onWindowMousedown(), props (+35 more)
...
Cohesion: 0.20
Nodes (10): lineWidth(), ScaleRenderer, drawEntryPoint(), drawExitPoint(), drawHaloRing(), drawLabel(), drawTick(), renderTradeMarkers() (+2 more)

### Community 42 - "GoldH1Preview.vue"
Cohesion: 0.10
Nodes (23): berlin, container, count, error, load(), loading, obCount, fetchDailyStructurePivots() (+15 more)
...
### Community 60 - "TradeSetupCockpit.vue"
Cohesion: 0.09
...
Cohesion: 0.10
Nodes (33): Two Runtimes, One Algorithm Set (Deliberate Duplication), usePriceChartLiquidity(), attachBonus(), refresh(), formatLiquidityLevelLabel(), levelOptions(), LIQUIDITY_STYLE_KEYS, liquidityLevelNaturalKey() (+25 more)
...
### Community 66 - "businessSecondsBetween"
Cohesion: 0.12
...
### Community 67 - "usePriceChartRsi.js"
Cohesion: 0.20
...
Cohesion: 0.13
Nodes (21): buildLevel(), detectLiquidityLevels(), isDownFractal(), isUpFractal(), LiquidityLevel, detectOrderBlocks(), HTF_FOREX_LABELS, HTF_FOREX_MIN_GAP_PIPS (+13 more)
...
### Community 75 - "chartTimeUtils.js"
Cohesion: 0.11
Nodes (17): mergeCandles(), computeNextReplayTime(), isTimeCovered(), mergeRecent(), nextCandleAfter(), replayFetchToMs(), snapToBarTime(), jumpToDivergence() (+9 more)
...
### Community 88 - "backfillTradeSetups.ts"
Cohesion: 0.16
Nodes (12): readForexCandlesArchiveFrom(), LiquidityLevel, SetupSweep, TRADE_SETUP_H1_FRACTAL_PERIOD, persistTradeSetupSweeps(), alarmFenster, Candle, [fensterVon, fensterBis] (+4 more)
...
Cohesion: 0.22
Nodes (15): cssColor(), refresh(), bullBearLabelSide(), collectNestedChain(), collectFibLevels(), computeFibLevels(), fibBetween(), firstCloseBelow() (+7 more)
...
### Community 108 - "biasCheck.ts"
Cohesion: 0.13
Nodes (30): berlinDayRangeUtcMs(), buildPendingDecisions(), findIntermediateLevel(), FindIntermediateLevelArgs, IntermediateLevelCandidate, isSpreadHourPivot(), PendingDecision, upsertBiasFields() (+22 more)
...
Cohesion: 0.12
Nodes (29): filterRelevantLevels(), PIP_SIZE, getLatestDailyStructureStartTime(), getObZones(), computeRangesPivots(), buildDataExport(), capStructurePivots(), coincidesWithHtf() (+21 more)

### Community 121 - "trading-monitor-mcp/orderBlockDetection.js"
Cohesion: 0.13
...
### Community 145 - "SessionsModal.vue"
Cohesion: 0.15
...
### Community 146 - "addPositionToDealingRange"
Cohesion: 0.67
...
### Community 148 - "fetchForexCandles"
Cohesion: 0.16
...
### Community 149 - "nearRelevantLiquidityLevels.ts"
Cohesion: 0.19
Nodes (19): berlinOffsetMinutes(), ALL_DAYS, attachRangeExtremes(), bonusLabelForPivot(), buildSessionContextLookup(), contextForPivot(), daysOrAll(), localMidnightUtc() (+11 more)

### Community 153 - "TargetPickerModal.vue"
Cohesion: 0.17
...
### Community 154 - "loopState.ts"
Cohesion: 0.18
Nodes (11): updateTradePosition(), closeLoopState(), HeartbeatEntry, LoopStatus, rowToState(), TradingLoopStateRow, UPDATE_FIELD_MAP, UpdateLoopStateArgs (+3 more)
...
### Community 160 - "daily-structure-pivots/index.ts"
Cohesion: 0.24
...
### Community 163 - "useHttpActivity.js"
Cohesion: 0.22
...
Cohesion: 0.14
Nodes (20): marketStructureTree, M5_STRUCTURE_STYLE_KEYS, usePriceChartMarketStructure(), computeRangesPivotsAndMetadata(), computeRangesPivotsFor(), refreshM5Structure(), refreshMarketStructure(), refreshRangesMarkers() (+12 more)
...
### Community 176 - "fxcmCandles.ts"
Cohesion: 0.22
Nodes (5): headers, fetchForexBatch(), FxcmCandle, PERIODS, readFxcmCandles()

### Community 177 - "backfillLiquidityLevels.ts"
Cohesion: 0.11
...
### Community 179 - "chartColors.test.js"
Cohesion: 0.20
...
### Community 181 - "chartColors.js"
Cohesion: 0.25
Nodes (5): chartColors, cssColorScaled(), DEFAULT_CHART_COLORS, hexToRgba(), rowStyle()

### Community 182 - "applyInnerMarketStructurePivot"
Cohesion: 0.25
...
## Knowledge Gaps
- **1241 isolated node(s):** `{ readFileSync }`, `{ join }`, `SKILL`, `{ execFileSync }`, `path` (+1236 more)
...
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `businessSecondsBetween`, `LiquidityLinePrimitive`, `usePriceChartMarketStructure.js`, `lineWidth`, `FibTickPrimitive`, `Vegapunk Slimming Results (-86%)`, `Pivot`?**
