...
## Corpus Check
- 552 files · ~561,738 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3248 nodes · 6586 edges · 167 communities (148 shown, 11 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `69a4f57e`
...
Cohesion: 0.02
Nodes (130): useSessionStorageRef(), addPositionToDealingRange(), tradesVisible(), antiConfluenceAddTrade, anyArmStateActive, ARM_HINTS, ARM_STATES, armedAction (+122 more)
...
Cohesion: 0.16
Nodes (20): buildPendingDecisions(), findIntermediateLevel(), FindIntermediateLevelArgs, IntermediateLevelCandidate, isSpreadHourPivot(), PendingDecision, assessForce(), assessLiquidityForce() (+12 more)
...
Cohesion: 0.06
Nodes (43): trendChain, accentStyle, antiConfluences, canTransfer, confirmationLabel(), confirmations, confluences, dateLabel (+35 more)

### Community 12 - "berlinDateStrFor"
Cohesion: 0.07
Nodes (60): berlinDateStrFor(), berlinDateTimeStrFor(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, toPips(), createDealingRange(), deleteDealingRange() (+52 more)
...
### Community 19 - "berlinOffsetMinutes"
Cohesion: 0.36
...
Cohesion: 0.15
Nodes (22): BERLIN_HM_FORMATTER, BERLIN_WEEKDAY_FORMATTER, berlinWeekdayAndMinutes(), isWithinTradingWindows(), TradingWindows, WeekdayGroup, getTradingSchedule(), ClassifiedNewsEvent (+14 more)

### Community 30 - "liquidityDetection.ts"
Cohesion: 0.11
Nodes (22): CORS_HEADERS, ExistingPivotRow, INSTRUMENTS, DB_READ_PAGE_SIZE, fetchAllRows(), ArchivableCandle, buildLevel(), detectLiquidityLevels() (+14 more)
...
Cohesion: 0.07
Nodes (15): drawIconLabel(), canShowLabels(), MIN_PIXELS_PER_HOUR_FOR_LABELS, MIN_PIXELS_PER_HOUR_FOR_LABELS_INTRADAY, refreshDivergence(), LiquidityLineRenderer, OB_ZONE_KEYS, positionsBox() (+7 more)
...
### Community 60 - "db.ts"
Cohesion: 0.06
Nodes (56): PIP_SIZE, addPinEntry(), addPinM5LiquidityEntry(), addPinM5ObEntry(), addPinRsiDivergenceEntry(), addTradeConfirmation(), AddTradeConfirmationArgs, addTradePosition() (+48 more)

### Community 61 - "usePriceChartLiquidity.js"
Cohesion: 0.12
Nodes (26): usePriceChartLiquidity(), attachBonus(), refresh(), liquidityLevelNaturalKey(), renderLiquidityLevels(), buildLevel(), detectLiquidityLevels(), filterRelevantLevels() (+18 more)

### Community 62 - "barSecondsFor"
Cohesion: 0.08
Nodes (36): asOfProbeCandles(), firstObFormationTimeAfter(), TriggerCandle, detectOrderBlocks(), HTF_FOREX_LABELS, HTF_FOREX_MIN_GAP_PIPS, LOWER_TF_LABELS, LOWER_TF_MIN_GAP_PIPS (+28 more)
...
Cohesion: 0.23
Nodes (10): openAntiConfluencePicker(), openTargetPicker(), mergedCandidates, getCurrentLiquidityLevels(), DEFAULT_LIQUIDITY_TARGET_LIMIT, DEFAULT_OB_TARGET_LIMIT, findNearestLiquidityTargets(), findNearestObTargets() (+2 more)
...
Cohesion: 0.10
Nodes (42): berlinDayRangeUtcMs(), isBoxInvalidated(), ALL_DAYS, attachRangeExtremes(), bonusLabelForPivot(), buildSessionContextLookup(), contextForPivot(), daysOrAll() (+34 more)
...
Cohesion: 0.08
Nodes (47): filterRelevantLevels(), dropLowerTfDuplicates(), filterRelevantRows(), getLatestDailyStructureStartTime(), getLiquidityLevels(), getObZones(), getSessions(), buildCandidatePool() (+39 more)
...
Cohesion: 0.11
Nodes (31): AgeTier, classifyAge(), MAJOR_MIN_SECONDS, MINOR_MAX_SECONDS, ageReferenceTime(), businessSecondsBetween(), formatAge(), targetLabel() (+23 more)
...
### Community 155 - "marketStructureAnalysisFib.test.js"
Cohesion: 0.29
...
Cohesion: 0.12
Nodes (13): cssColor(), cssColorScaled(), hexToRgba(), refreshInvalidationLinesInternal(), refreshTradeConfirmationLinksInternal(), refreshTradeTargetLinksInternal(), tradeLikeEntriesForCandles(), usePriceChartTradeSetupDrawing() (+5 more)
...
### Community 161 - "MAX_TARGET_DISTANCE_PIPS Constant"
Cohesion: 0.50
...
### Community 165 - "cTrader Open API as Forex Candle Source"
Cohesion: 0.40
...
### Community 166 - "applyInnerMarketStructurePivot"
Cohesion: 0.25
...
- **Why does `businessSecondsBetween()` connect `findAntiConfluenceCandidates.js` to `tradeSetup.ts`, `biasCheck.ts`, `liquidity.js`, `dealingRangeLoop.ts`, `dataExport.ts`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `marketStructureAnalysis Developer Notes` connect `Vegapunk Slimming Results (-86%)` to `fachdoku-router/SKILL.md`, `marketStructureAnalysis Rules Overview`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `lineWidth`, `liquidity.js`, `Vegapunk Slimming Results (-86%)`, `cssColor`?**
...
- **Should `Dashboard.vue` be split into smaller, more focused modules?**
  _Cohesion score 0.015167930660888408 - nodes in this community are weakly interconnected._
