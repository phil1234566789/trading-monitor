...
## Corpus Check
- 415 files · ~428,926 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2801 nodes · 5619 edges · 133 communities (118 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 109 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c05b1a96`
...
Cohesion: 0.06
Nodes (70): BERLIN_HM_FORMATTER, BERLIN_WEEKDAY_FORMATTER, berlinWeekdayAndMinutes(), isWithinTradingWindows(), TradingWindows, WeekdayGroup, berlinDateStrFor(), berlinDateTimeStrFor() (+62 more)

### Community 3 - "dataExport.ts"
Cohesion: 0.06
Nodes (73): isBoxInvalidated(), detectSetupObs(), berlinOffsetMinutes(), applyAsOf(), applyAsOfZones(), dropLowerTfDuplicates(), fetchActiveTscRangeId(), fetchAllRows() (+65 more)
...
Cohesion: 0.09
Nodes (22): refreshMarketStructure(), bullBearLabelSide(), Candle, ArrowPrimitive, collectFibLevels(), collectH1LqLevels(), collectNestedChain(), computeFibLevels() (+14 more)
...
Cohesion: 0.11
Nodes (23): postChartAnnotations(), buildServer(), MCP_TOKEN, toPips(), ANNOTATION_SCHEMA, DRAWING_GROUP_SCHEMA, registerAnnotationTools(), VALID_TYPES (+15 more)
...
Cohesion: 0.13
Nodes (24): usePriceChartLiquidity(), refresh(), computeLiquidityLevelsForExport(), levelOptions(), LIQUIDITY_STYLE_KEYS, liquidityLevelNaturalKey(), liquidityStyleTimeframe(), renderLiquidityLevels() (+16 more)
...
Cohesion: 0.11
Nodes (34): direction, emit, entryPrice, errorMsg, levels, precision, props, reasoning (+26 more)
...
### Community 30 - "TargetPickerModal.vue"
Cohesion: 0.16
Nodes (11): candidateLabel(), candidatePrice(), emit, mergedCandidates, precision, props, candidateLabel(), emit (+3 more)
...
Cohesion: 0.15
Nodes (22): marketStructureTree, buildDataExport(), compute1hStructureState(), computeExportTimeframeData(), computeObZonesForExport(), computeTrendChainAges(), DATE_FORMATTER, dropUnknownStructureLevels() (+14 more)
...
Cohesion: 0.10
Nodes (27): buildLevel(), detectLiquidityLevels(), filterRelevantLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD, LIQUIDITY_MAX_RELEVANT, LiquidityLevel (+19 more)
...
### Community 57 - "chartColors.test.js"
Cohesion: 0.18
...
Cohesion: 0.09
Nodes (28): berlinDayRangeUtcMs(), getForexCandlesArchiveUpTo(), BAR_SECONDS, barSecondsFor(), Candle, fetchLiveForexCandles(), fetchLiveForexCandlesOnce(), isRetryable() (+20 more)
...
Cohesion: 0.29
Nodes (5): usePriceChartMarketStructure(), computeRangesPivotsAndMetadata(), computeRangesPivotsFor(), pivotForDisplay(), BASE_CTX
...
Cohesion: 0.24
Nodes (10): closeLoopState(), getLoopStateForDay(), HeartbeatEntry, LoopLevel, LoopStatus, rowToState(), UPDATE_FIELD_MAP, UpdateLoopStateArgs (+2 more)
...
### Community 90 - "tradeMarkers.js"
Cohesion: 0.42
Nodes (7): drawEntryPoint(), drawExitPoint(), drawHaloRing(), drawLabel(), drawTick(), renderTradeMarkers(), tradeOptions()
...
Cohesion: 0.18
Nodes (19): cssColor(), cssColorScaled(), hexToRgba(), lineWidth(), tradesVisibleForCandles(), refreshInvalidationLinesInternal(), refreshTradeConfirmationLinksInternal(), refreshTradeSetupLinksInternal() (+11 more)
...
## Knowledge Gaps
- **1051 isolated node(s):** `NODES`, `EDGES`, `NextActionEntry`, `NEXT_ACTION_MAP`, `NEXT_ACTION_FALLBACK` (+1046 more)
...
- **Why does `trading_schedules Table` connect `Fachdoku-Router Skill` to `dealingRangeLoop.ts`?**
