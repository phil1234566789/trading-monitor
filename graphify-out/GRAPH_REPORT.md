...
## Corpus Check
- 457 files · ~452,284 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2936 nodes · 5960 edges · 136 communities (118 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 109 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `98acbb35`
...
Cohesion: 0.08
Nodes (58): berlinDateStrFor(), berlinDateTimeStrFor(), computeHtfWatchLevels(), computeWatchLevels(), appendHeartbeat(), closeLoopState(), getLoopStateForDay(), HeartbeatEntry (+50 more)

### Community 3 - "backfillLiquidityLevels.ts"
Cohesion: 0.10
Nodes (23): LIQUIDITY_FRACTAL_PERIOD, backfillOne(), BAR_CONFIG, BARS, CandleRow, correctMissedTouches(), fetchAllCandles(), INSTRUMENTS (+15 more)

### Community 4 - "PriceChart.vue"
Cohesion: 0.03
Nodes (79): mergeRecent(), replayFetchToMs(), activeMetadataSnapshot, allCandles, antiConfluencePickerCurrentPrice, antiConfluencePickerDivergenceCandidates, antiConfluencePickerHoveredLiquidityKey, antiConfluencePickerHoveredObKey (+71 more)
...
Cohesion: 0.10
Nodes (36): berlinWeekdayAndMinutes(), WeekdayGroup, getNewsEvents(), getTradingSchedule(), deriveStepAndCase(), LoadedMachine, loadOrCreateMachineForDay(), persistTransition() (+28 more)
...
Cohesion: 0.33
Nodes (5): findClickedFibLevel(), usePriceChartMarketStructure(), computeRangesPivotsAndMetadata(), computeRangesPivotsFor(), getCurrentFibLevels()
...
Cohesion: 0.06
Nodes (55): AgeTier, businessSecondsBetween(), classifyAge(), classifyInducementAge(), inducementAgeRange(), InducementClass, MAJOR_MIN_HOURS, MAJOR_MIN_SECONDS (+47 more)
...
### Community 34 - "ClaudeAnnotationsModal.vue"
Cohesion: 0.20
...
Cohesion: 0.11
Nodes (21): postChartAnnotations(), buildServer(), MCP_TOKEN, NEXT_ACTION_FALLBACK, NEXT_ACTION_MAP, NextActionEntry, toPips(), ANNOTATION_SCHEMA (+13 more)
...
Cohesion: 0.06
Nodes (70): buildLevel(), detectLiquidityLevels(), filterRelevantLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_MAX_RELEVANT, LiquidityLevel, berlinOffsetMinutes() (+62 more)
...
Cohesion: 0.10
Nodes (25): cachedCandlesUpTo(), cacheKey(), fetchCandlesCached(), getCachedCandles(), mergeCandles(), openDb(), safeCompleteUpTo(), setCachedCandles() (+17 more)
...
### Community 72 - "chartTimeUtils.js"
Cohesion: 0.19
...
### Community 91 - "marketStructureAnalysis Rules Overview"
Cohesion: 0.06
Nodes (40): HTF_FOREX_MIN_GAP_PIPS Constant, LOWER_TF_MIN_GAP_PIPS Constant, Pip-/Pixel-Schwellwerte Übersicht, MAX_TARGET_DISTANCE_PIPS Constant, PIP_SIZE Constant, RANGE_FIB_MIN_PP_DISTANCE_PIPS Constant, TRADE_SETUP_LS_MAX_DISTANCE_M5 Constant, find_targets Target-Candidate Algorithm Design (+32 more)

### Community 92 - "validationEvidence.ts"
Cohesion: 0.10
Nodes (34): DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, createDealingRange(), deleteDealingRange(), fetchActiveTscRangeId(), fetchDealingRangeCockpit(), getOpenOppositeDealingRanges() (+26 more)
...
Cohesion: 0.10
Nodes (28): cssColor(), cssColorScaled(), hexToRgba(), lineWidth(), tradesVisibleForCandles(), candidateLabel(), candidatePrice(), emit (+20 more)

### Community 98 - "reads.ts"
Cohesion: 0.11
Nodes (34): berlinDayRangeUtcMs(), getForexCandlesArchive(), getForexCandlesArchiveUpTo(), getJournal(), getTradeSetups(), getTradeSetupWinrate(), getTradingAccounts(), computeEma() (+26 more)
...
## Knowledge Gaps
- **1102 isolated node(s):** `DEFAULT_LIQUIDITY_TARGET_LIMIT`, `DEFAULT_OB_TARGET_LIMIT`, `MAX_TARGET_DISTANCE_PIPS`, `CandleRow`, `ClassifiedDivergence` (+1097 more)
...
- **Why does `businessSecondsBetween()` connect `backfillTradeSetupOutcomes.ts` to `dataExport.ts`, `liquidity.js`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `marketStructureAnalysis Developer Notes` connect `Vegapunk Slimming Results (-86%)` to `fachdoku-router/SKILL.md`, `marketStructureAnalysis Rules Overview`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `businessSecondsBetween()` connect `liquidity.js` to `cssColor`, `candleCache.js`, `PriceChart.vue`, `chartTimeUtils.js`, `tradeSetupCockpit.ts`?**
