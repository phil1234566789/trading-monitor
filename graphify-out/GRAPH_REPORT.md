...
## Corpus Check
- 583 files · ~617,292 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3406 nodes · 6883 edges · 176 communities (154 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 122 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ed65ad29`
...
### Community 2 - "priceChartLiquidity.js"
Cohesion: 0.15
Nodes (17): usePriceChartLiquidity(), attachBonus(), refresh(), selectRelevantHtfLevels(), LQ_RELEVANCE, applyReplayAsOf(), barsAfterPivotSec(), coincidesWithHtf() (+9 more)

### Community 3 - "berlinDateStrFor"
Cohesion: 0.09
Nodes (44): berlinDateStrFor(), deleteDealingRange(), getOpenOppositeDealingRanges(), computeEvidenceScore(), EvidenceScoreBreakdownEntry, EvidenceScoreInput, EvidenceScoreResult, buildServer() (+36 more)
...
Cohesion: 0.19
Nodes (22): applyCandleData(), clearTradeSetupFocus(), clipReplay(), computeTradeSetupsInternal(), focusTradeSetup(), loadTradeSetupM5(), refreshChart(), refreshCockpitInternal() (+14 more)
...
Cohesion: 0.05
Nodes (48): Plan: find_targets Algorithmus, TSC-Neuaufbau Precondition, trendChain, accentStyle, antiConfluences, canTransfer, confirmations, confluences (+40 more)

### Community 12 - "tradeMarkers.js"
Cohesion: 0.13
...
Cohesion: 0.07
Nodes (48): berlinDateTimeStrFor(), assessInducement(), computeHtfWatchLevels(), computeWatchLevels(), ForceLiquidityInput, ForceObInput, appendHeartbeat(), closeLoopState() (+40 more)
...
### Community 25 - "db.ts"
Cohesion: 0.08
Nodes (39): addPinEntry(), addPinM5LiquidityEntry(), addPinM5ObEntry(), addPinRsiDivergenceEntry(), addTradeConfirmation(), AddTradeConfirmationArgs, AddTradeTargetArgs, asOfProbeCandles() (+31 more)
...
### Community 27 - "pivotForDisplay"
Cohesion: 0.67
Nodes (3): marketStructureTree, pivotForDisplay(), summarizeMarketStructureState()
...
Cohesion: 0.52
Nodes (5): fetchAlarmLog(), fetchTouchedLiquidityLevels(), fetchTradeSetups(), fetchTouchedZones(), MAX_PROTOKOLL_ZEILEN
...
Cohesion: 0.11
Nodes (22): minutesToTimeInput(), timeInputToMinutes(), emit, instrumentSessions, props, WEEKDAY_DISPLAY_ORDER, usePriceChartCockpit(), refreshCockpit() (+14 more)
...
Cohesion: 0.12
Nodes (7): drawIconLabel(), MIN_PIXELS_PER_HOUR_FOR_LABELS, MIN_PIXELS_PER_HOUR_FOR_LABELS_INTRADAY, DivergenceLinePaneView, DivergenceLinePrimitive, DivergenceLineRenderer, mergePinnedDivergences()
...
Cohesion: 0.13
Nodes (19): nextCandlePollDelay(), mergeRecent(), replayFetchToMs(), loadInitial(), loadRangesCandles(), m5ClockEnabled(), pollRecent(), replayToMs() (+11 more)
...
Cohesion: 0.06
Nodes (28): cssColor(), cssColorScaled(), hexToRgba(), lineWidth(), tradesVisibleForCandles(), canShowLabels(), obZoneCtx(), refreshInvalidationLinesInternal() (+20 more)

### Community 42 - "supabaseClient.js"
Cohesion: 0.12
Nodes (24): berlin, container, count, error, load(), loading, obCount, fetchDailyStructurePivots() (+16 more)
...
Cohesion: 0.07
Nodes (35): usePriceChartTradeSetups(), fetchM5Candles(), fetchTrendAnalysisM5History(), getTrendAnalysisM5Candles(), CALLOUT_STACK_GAP_PX, CATEGORY_COLOR_KEY, COPIED_FEEDBACK_MS, DEBUG_AUTOSAVE_INTERVAL_MS (+27 more)

### Community 46 - "marketStructureAnalysis Rules Overview"
Cohesion: 0.07
Nodes (35): base, candles, data, iso(), rows, zones, HTF_FOREX_MIN_GAP_PIPS Constant, LOWER_TF_MIN_GAP_PIPS Constant (+27 more)
...
Cohesion: 0.12
Nodes (19): liquidityLevelNaturalKey(), obZoneEntryNaturalKey(), hoveredPinObZoneKey, invalidationLiquidityKeys, journalLiquidityCategories, onSelectPin(), pinEntryVisible(), pinJumpHint (+11 more)
...
Cohesion: 0.14
Nodes (22): ageReferenceTime(), businessSecondsBetween(), computeNextReplayTime(), formatAge(), nextCandleAfter(), snapToBarTime(), nextReplayTime(), ageSuffix() (+14 more)

### Community 62 - "fallClassifier.ts"
Cohesion: 0.08
Nodes (37): AgeTier, businessSecondsBetween(), classifyAge(), computeSweepAgeHours(), MAJOR_MIN_HOURS, MAJOR_MIN_SECONDS, MINOR_MAX_HOURS, MINOR_MAX_SECONDS (+29 more)
...
Cohesion: 0.12
Nodes (21): AgeTier, classifyAge(), MAJOR_MIN_SECONDS, MINOR_MAX_SECONDS, refreshTradeTargetLinksInternal(), targetLabel(), sweepTier, targetLabel() (+13 more)
...
Cohesion: 0.10
Nodes (19): activeHint, { activeLabels, isActive }, isFresh, { lastSuccessAt }, lastUpdateText, now, showDrawingsModal, statusDotClass (+11 more)
...
Cohesion: 0.13
Nodes (31): isBoxInvalidated(), detectSetupObs(), fetchActiveTscRangeId(), fetchDealingRangeCockpit(), findRecentTradeSetupIdsByKey(), getForexCandlesArchive(), getJournal(), getNewsEvents() (+23 more)
...
Cohesion: 0.06
Nodes (25): refreshMarketStructure(), bullBearLabelSide(), Candle, collectNestedChain(), ArrowPaneView, ArrowPrimitive, ArrowRenderer, collectFibLevels() (+17 more)

### Community 93 - "backfillObZones.ts"
Cohesion: 0.29
...
### Community 104 - "verifyTouched.js"
Cohesion: 0.43
...
Cohesion: 0.15
Nodes (30): berlinDayRangeUtcMs(), upsertBiasFields(), deriveStepAndCase(), LoadedMachine, loadMachineForDayOrNull(), loadOrCreateMachineForDay(), persistTransition(), rehydrateActor() (+22 more)
...
Cohesion: 0.06
Nodes (70): berlinOffsetMinutes(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, filterRelevantLevels(), PIP_SIZE, toPips(), ALL_DAYS (+62 more)

### Community 121 - "replayAsOf.ts"
Cohesion: 0.29
Nodes (12): applyAsOf(), applyAsOfZones(), earliestAmbiguousEventSec(), existsAsOf(), M5_SECONDS, ProbeCandle, resolveEventSec(), toSec() (+4 more)

### Community 122 - "src/pipConfig.js"
Cohesion: 0.23
Nodes (12): fromPips(), toPips(), KEINE_SKALA, R_SCALE_MINIMUM, R_SCALE_STEPS, rScaleLevels(), rScaleSpec(), STOPP_DECKEL_PIPS (+4 more)
...
### Community 159 - "format.js"
Cohesion: 0.09
Nodes (23): emit, noteSaveTimers, onEntryClick(), onNoteInput(), OUTCOME_LABEL, props, rows, emit (+15 more)
...
Cohesion: 0.25
Nodes (10): M5_STRUCTURE_STYLE_KEYS, buildMarketStructureState(), computeRangesPivots(), deriveTrendReaction(), effectiveTrend(), RANGES_CANDLE_BUFFER, buildStructureWithPhases(), renderTrendPhaseBands() (+2 more)
...
Cohesion: 0.20
Nodes (12): MAX_TARGET_DISTANCE_PIPS Constant, find_targets Target-Candidate Algorithm Design, openAntiConfluencePicker(), openTargetPicker(), mergedCandidates, getCurrentLiquidityLevels(), DEFAULT_LIQUIDITY_TARGET_LIMIT, DEFAULT_OB_TARGET_LIMIT (+4 more)

### Community 189 - "LiquidityLinePrimitive"
Cohesion: 0.13
...
## Knowledge Gaps
- **1242 isolated node(s):** `SYMBOLS`, `goldPreview`, `currentSymbol`, `tradesPanelHeight`, `tradesPanelRef` (+1237 more)
...
- **Why does `businessSecondsBetween()` connect `fallClassifier.ts` to `tradeSetup.ts`, `findAntiConfluenceCandidates.js`, `dealingRangeLoop.ts`, `dataExport.ts`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `fmtPrice`, `usePriceChartMarketStructure.js`, `cssColor`, `Vegapunk Slimming Results (-86%)`, `LiquidityLinePrimitive`, `liquidity.js`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **What connects `SYMBOLS`, `goldPreview`, `currentSymbol` to the rest of the system?**
  _1242 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Dashboard.vue` be split into smaller, more focused modules?**
  _Cohesion score 0.014783737888322844 - nodes in this community are weakly interconnected._
