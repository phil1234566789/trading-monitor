...
Cohesion: 0.01
Nodes (132): useSessionStorageRef(), useTabScopedRef(), rsiDivergenceEntryNaturalKey(), addPositionToDealingRange(), antiConfluenceAddTrade, anyArmStateActive, ARM_HINTS, ARM_STATES (+124 more)
...
Cohesion: 0.10
Nodes (29): cachedCandlesUpTo(), cacheKey(), fetchCandlesCached(), getCachedCandles(), mergeCandles(), openDb(), safeCompleteUpTo(), setCachedCandles() (+21 more)

### Community 3 - "TradeSetupCockpit.vue"
Cohesion: 0.08
Nodes (32): Plan: find_targets Algorithmus, TSC-Neuaufbau Precondition, accentStyle, antiConfluences, canTransfer, confirmationLabel(), confirmations, confluences (+24 more)

### Community 4 - "PriceChart.vue"
Cohesion: 0.03
Nodes (93): activeMetadataSnapshot, allCandles, antiConfluencePickerCurrentPrice, antiConfluencePickerDivergenceCandidates, antiConfluencePickerHoveredLiquidityKey, antiConfluencePickerHoveredObKey, antiConfluencePickerInvalidationObCandidates, antiConfluencePickerObCandidates (+85 more)
...
Cohesion: 0.11
Nodes (28): toPips(), postChartAnnotations(), buildServer(), MCP_TOKEN, berlinTwinKey(), json(), withBerlinTimes(), NEXT_ACTION_FALLBACK (+20 more)
...
Cohesion: 0.06
Nodes (76): berlinDateStrFor(), berlinDateTimeStrFor(), assessInducement(), checkFallFour(), CheckFallFourInput, computeHtfWatchLevels(), computeWatchLevels(), FallFourResult (+68 more)
...
### Community 19 - "loadRangesCandles"
Cohesion: 0.14
...
### Community 21 - "liquidityDetection.ts"
Cohesion: 0.12
Nodes (17): CORS_HEADERS, ExistingPivotRow, INSTRUMENTS, buildLevel(), detectLiquidityLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_MAX_RELEVANT (+9 more)

### Community 22 - "newsMarkers.js"
Cohesion: 0.15
Nodes (10): refreshNewsMarkers(), DAY_KEY_FORMATTER, extrapolatedX(), formatEventLabel(), isSameBerlinDay(), NewsMarkerPaneView, NewsMarkerPrimitive, renderNewsMarkers() (+2 more)

### Community 23 - "orderBlocks.js"
Cohesion: 0.14
Nodes (24): emit, measureClick(), measurePointAt(), onAntiConfluencePickerHover(), onAntiConfluencePickerSelect(), onTargetPickerHover(), onTargetPickerSelect(), refreshLiquidityInternal() (+16 more)
...
### Community 41 - "usePolledFetch.js"
Cohesion: 0.43
Nodes (5): usePolledFetch(), load(), lastSuccessAt, useStatusBar(), markSuccess()

### Community 42 - "supabaseClient.js"
Cohesion: 0.08
Nodes (27): fetchAlarmLog(), fetchTouchedLiquidityLevels(), fetchTradeSetups(), ALARM_TYPES, fetchAlarmSettings(), setAlarmEnabled(), fetchDailyStructurePivots(), DB_READ_PAGE_SIZE (+19 more)

### Community 43 - "clipReplay"
Cohesion: 0.10
Nodes (35): cssColorScaled(), hexToRgba(), tradesVisibleForCandles(), buildActiveMetadataSnapshotInternal(), clearTradeSetupFocus(), clipReplay(), computeTradeSetupsInternal(), focusTradeSetup() (+27 more)
...
Cohesion: 0.10
Nodes (17): ANNOTATION_COLOR, annotationAnchorPoint(), AnnotationsPaneView, AnnotationsPrimitive, AnnotationsRenderer, parseAnnotations(), resolveLabelPlacements(), resolveTime() (+9 more)
...
### Community 59 - "replayAsOf.ts"
Cohesion: 0.26
Nodes (13): LIQUIDITY_FRACTAL_PERIOD, applyAsOf(), applyAsOfZones(), earliestAmbiguousEventSec(), existsAsOf(), M5_SECONDS, ProbeCandle, resolveEventSec() (+5 more)

### Community 60 - "db.ts"
Cohesion: 0.05
Nodes (78): addPinEntry(), addPinM5LiquidityEntry(), addPinM5ObEntry(), addPinRsiDivergenceEntry(), addTradeConfirmation(), AddTradeConfirmationArgs, addTradePosition(), addTradeTarget() (+70 more)

### Community 61 - "usePriceChartLiquidity.js"
Cohesion: 0.12
Nodes (27): usePriceChartLiquidity(), attachBonus(), refresh(), liquidityLevelNaturalKey(), renderLiquidityLevels(), buildLevel(), detectLiquidityLevels(), filterRelevantLevels() (+19 more)

### Community 62 - "barSecondsFor"
Cohesion: 0.21
Nodes (9): firstObFormationTimeAfter(), TriggerCandle, BAR_SECONDS, barSecondsFor(), confirmationOffsetSec(), coveredByCandles(), verifyLevelTouched(), verifyZoneTouched() (+1 more)
...
Cohesion: 0.19
Nodes (10): emit, lessonBadges(), OUTCOME_LABEL, props, rangeLabel(), showCommission, fmtDate(), fmtMoney() (+2 more)
...
### Community 71 - "usePriceChartRsi.js"
Cohesion: 0.20
...
Cohesion: 0.06
Nodes (40): advanceNestedTrendInner(), applyInnerMarketStructurePivot(), applyMarketStructurePivot(), initMarketStructureState(), pivot1, pivot2, pivot3, pivot4 (+32 more)

### Community 79 - "forbiddenSession.ts"
Cohesion: 0.28
...
Cohesion: 0.18
Nodes (16): drQuoten, drQuotenBlock(), FVG_BAENDER, FVG_BAND_N, fvgQuote(), leiter(), PIP_BAENDER, PIP_ZIELE (+8 more)
...
Cohesion: 0.06
Nodes (68): berlinOffsetMinutes(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, filterRelevantLevels(), PIP_SIZE, ALL_DAYS, attachRangeExtremes() (+60 more)
...
Cohesion: 0.13
Nodes (22): cssColor(), lineWidth(), refreshMarketStructure(), refresh(), bullBearLabelSide(), collectFibLevels(), collectNestedChain(), computeFibLevels() (+14 more)
...
Cohesion: 0.15
Nodes (17): daily_structure_pivots Table, forex_candles Table, ob_zones Table, get_forex_candles_archive MCP Tool, Archive-First Auto-Reload Pattern (Tried, Then Reverted), BTC Scope Removal from Chart-Objects Plan, OB-Zones Canonical FK Consolidation Approach, 1H/4H DB-Read vs Live-Recompute Decision (+9 more)

### Community 121 - "tradeSetup.js"
Cohesion: 0.12
Nodes (20): Two Runtimes, One Algorithm Set (Deliberate Duplication), computeTradeSetups(), collectH1LqLevels(), toLqLevel(), closesBeyondLevel(), collectObSweeps(), detectSetupObs(), detectTradeSetups() (+12 more)
...
Cohesion: 0.15
Nodes (22): AgeTier, classifyAge(), MAJOR_MIN_SECONDS, MINOR_MAX_SECONDS, ageReferenceTime(), businessSecondsBetween(), formatAge(), targetLabel() (+14 more)

### Community 141 - "backfillForexCandles.ts"
Cohesion: 0.11
...
### Community 158 - "ScalePrimitive"
Cohesion: 0.20
Nodes (3): ScalePaneView, ScalePrimitive, ScaleRenderer

### Community 159 - "usePriceChartMarketStructure"
Cohesion: 0.13
Nodes (17): copyJson(), copyJsonAndSaveLocally(), findClickedFibLevel(), usePriceChartMarketStructure(), computeRangesPivotsAndMetadata(), computeRangesPivotsFor(), fetchRangesCandles(), getCurrentFibLevels() (+9 more)
...
## Knowledge Gaps
- **1182 isolated node(s):** `{ execFileSync }`, `path`, `TRADING_REPO`, `{ execFileSync }`, `path` (+1177 more)
...
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `clipReplay`, `FibTickPrimitive`, `liquidity.js`, `ArrowPrimitive`, `Vegapunk Slimming Results (-86%)`?**
...
- **Should `Dashboard.vue` be split into smaller, more focused modules?**
  _Cohesion score 0.01492678318375059 - nodes in this community are weakly interconnected._
