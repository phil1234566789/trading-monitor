...
## Corpus Check
- 400 files · ~422,501 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2779 nodes · 5583 edges · 131 communities (117 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 110 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `afa266ba`
...
### Community 21 - "fetchForexCandles"
Cohesion: 0.09
...
### Community 86 - "Dealing-Range-Anlegen Skill"
Cohesion: 0.18
...
### Community 99 - "ClaudeAnnotationsModal.vue"
Cohesion: 0.25
...
### Community 101 - "updateDealingRange"
Cohesion: 0.36
...
### Community 122 - "addPositionToDealingRange"
Cohesion: 0.67
...
## Knowledge Gaps
- **1038 isolated node(s):** `CandleRow`, `ClassifiedDivergence`, `SessionOcc`, `SessionRow`, `DataSnapshotArgs` (+1033 more)
...
- **Why does `Trading-Monitor Project Overview (CLAUDE.md)` connect `Trading-Monitor Project Overview (CLAUDE.md)` to `Plan: POI-Strategie-Findung, Backtesting & Trade-Notifications`, `tradeSetup.js`, `/task do Mode`, `Fachdoku-Router Skill`, `Plan: Forex-Chart-Objekte Datengrundlage`?**
