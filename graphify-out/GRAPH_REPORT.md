...
## Corpus Check
- 548 files · ~561,341 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3241 nodes · 6574 edges · 163 communities (142 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `60365749`
...
### Community 2 - "usePriceChartMarketStructure.js"
Cohesion: 0.09
Nodes (32): cachedCandlesUpTo(), cacheKey(), fetchCandlesCached(), getCachedCandles(), mergeCandles(), openDb(), safeCompleteUpTo(), setCachedCandles() (+24 more)

### Community 3 - "TradeSetupCockpit.vue"
Cohesion: 0.07
Nodes (32): confirmationLabel(), accentStyle, antiConfluences, canTransfer, confirmationLabel(), confirmations, confluences, dateLabel (+24 more)

### Community 4 - "PriceChart.vue"
Cohesion: 0.03
Nodes (99): activeMetadataSnapshot, allCandles, antiConfluencePickerCurrentPrice, antiConfluencePickerDivergenceCandidates, antiConfluencePickerHoveredLiquidityKey, antiConfluencePickerHoveredObKey, antiConfluencePickerInvalidationObCandidates, antiConfluencePickerObCandidates (+91 more)
...
Cohesion: 0.06
Nodes (78): berlinDateStrFor(), berlinDateTimeStrFor(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, addPinEntry(), addPinM5LiquidityEntry(), addPinM5ObEntry() (+70 more)

### Community 8 - "usePriceChartRsi.js"
Cohesion: 0.16
Nodes (21): refreshDivergence(), refreshRsi(), buildDivergenceEntry(), collectDivergenceHistory(), computeRsi(), DEFAULT_DIVERGENCE_FRACTAL_PERIOD, DEFAULT_DIVERGENCE_HISTORY_COUNT, DEFAULT_DIVERGENCE_LOOKBACK_BARS (+13 more)
...
Cohesion: 0.13
Nodes (18): trendChain, trendChainDisplay, RangeTrend, ANTI_CONFLUENCE_COLOR, ANTI_CONFLUENCE_THRESHOLD, AntiConfluence, computeTrendChain(), formatTrendAge() (+10 more)

### Community 12 - "biasCheck.ts"
Cohesion: 0.13
Nodes (30): berlinDayRangeUtcMs(), buildPendingDecisions(), findIntermediateLevel(), isSpreadHourPivot(), findNearestLiquidityTargets(), findNearestObTargets(), upsertBiasFields(), deriveStepAndCase() (+22 more)
...
### Community 19 - "db.ts"
Cohesion: 0.05
Nodes (65): addTradeConfirmation(), AddTradeConfirmationArgs, addTradePosition(), addTradeTarget(), AddTradeTargetArgs, asOfProbeCandles(), createTrade(), CreateTradeArgs (+57 more)
...
Cohesion: 0.09
Nodes (37): HTF_FOREX_MIN_GAP_PIPS Constant, LOWER_TF_MIN_GAP_PIPS Constant, Pip-/Pixel-Schwellwerte Übersicht, MIN_PIXELS_PER_HOUR_FOR_LABELS Constants, PIP_SIZE Constant, RANGE_FIB_MIN_PP_DISTANCE_PIPS Constant, TRADE_SETUP_LS_MAX_DISTANCE_M5 Constant, poi-watcher 4H+1H OB-Zonen-Wächter Edge Function (+29 more)
...
Cohesion: 0.13
Nodes (21): BERLIN_HM_FORMATTER, BERLIN_WEEKDAY_FORMATTER, berlinWeekdayAndMinutes(), isWithinTradingWindows(), TradingWindows, WeekdayGroup, FindIntermediateLevelArgs, IntermediateLevelCandidate (+13 more)
...
Cohesion: 0.21
Nodes (11): fetchAllRows(), getNewsEvents(), backfillOne(), BAR_CONFIG, BARS, CandleRow, correctMissedTouches(), fetchAllCandles() (+3 more)
...
Cohesion: 0.25
Nodes (9): computeNextReplayTime(), isTimeCovered(), nextCandleAfter(), snapToBarTime(), nextReplayTime(), computeJumpViewport(), loadCandlesAroundTrade(), candle() (+1 more)

### Community 67 - "liquidity.ts"
Cohesion: 0.70
...
Cohesion: 0.14
Nodes (27): isBoxInvalidated(), detectSetupObs(), fetchActiveTscRangeId(), findRecentTradeSetupIdsByKey(), getForexCandlesArchive(), getJournal(), getTradeSetups(), getTradingAccounts() (+19 more)
...
Cohesion: 0.05
Nodes (47): candidateLabel(), candidatePrice(), emit, mergedCandidates, precision, props, emit, noteSaveTimers (+39 more)

### Community 92 - "detectLiquidityLevels"
Cohesion: 0.25
Nodes (9): computeTradeSetups(), buildLevel(), detectLiquidityLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_MAX_RELEVANT, detectSetupObs(), mergeDbTradeSetups() (+1 more)

### Community 93 - "dataExport.ts"
Cohesion: 0.06
Nodes (72): buildLevel(), detectLiquidityLevels(), filterRelevantLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD, LIQUIDITY_MAX_RELEVANT, LiquidityLevel (+64 more)
...
Cohesion: 0.12
Nodes (21): CURRENCIES, emit, LIST_FORMATTER, newCurrency, newDateTime, newTitle, saving, submit() (+13 more)
...
Cohesion: 0.13
Nodes (20): Candle, ArrowPrimitive, collectFibLevels(), collectH1LqLevels(), collectNestedChain(), computeFibLevels(), fibBetween(), firstCloseBelow() (+12 more)
...
Cohesion: 0.06
Nodes (43): formatDatedTime(), formatPips(), MEASURE_COLOR, measureDrawing(), drQuoten, usePriceChartTradeSetupDrawing(), refresh(), drQuotenBlock() (+35 more)
...
Cohesion: 0.19
Nodes (18): jumpToDivergence(), jumpToPin(), jumpToTimeRange(), jumpToTrade(), DB_ARCHIVED_BARS, fetchArchivedPage(), fetchArchivedUpTo(), fetchCandles() (+10 more)
...
### Community 124 - "usePriceChartRsi"
Cohesion: 0.25
Nodes (7): nativeLineWidth(), usePriceChartRsi(), applyColorOptions(), applyLineWidthOptions(), create(), refreshEma(), computeEma()
...
Cohesion: 0.13
Nodes (13): DB_READ_PAGE_SIZE, ArchivableCandle, readForexCandlesArchiveFrom(), TRADE_SETUP_H1_FRACTAL_PERIOD, TRADE_SETUP_M5_FRACTAL_PERIOD, persistTradeSetupSweeps(), alarmFenster, Candle (+5 more)
...
Cohesion: 0.14
Nodes (25): AgeTier, classifyAge(), MAJOR_MIN_SECONDS, MINOR_MAX_SECONDS, ageReferenceTime(), businessSecondsBetween(), formatAge(), targetLabel() (+17 more)
...
### Community 163 - "berlinOffsetMinutes"
Cohesion: 0.36
...
- **Why does `businessSecondsBetween()` connect `liquidity.js` to `chartTimeUtils.js`, `TradeSetupCockpit.vue`, `PriceChart.vue`, `tradeSetup.js`, `findAntiConfluences.js`, `cssColor`, `tradeSetupCockpit.ts`?**
