...
## Corpus Check
- 556 files · ~567,363 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3274 nodes · 6647 edges · 176 communities (154 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5d0e29fb`
...
Cohesion: 0.09
Nodes (22): Plan: find_targets Algorithmus, TSC-Neuaufbau Precondition, emit, accentStyle, antiConfluences, canTransfer, confirmations, confluences (+14 more)

### Community 4 - "PriceChart.vue"
Cohesion: 0.03
Nodes (75): PIP_SIZE Constant, TRADE_SETUP_LS_MAX_DISTANCE_M5 Constant, activeMetadataSnapshot, allCandles, antiConfluencePickerCurrentPrice, antiConfluencePickerDivergenceCandidates, antiConfluencePickerHoveredLiquidityKey, antiConfluencePickerHoveredObKey (+67 more)
...
### Community 7 - "validationEvidence.ts"
Cohesion: 0.12
...
### Community 9 - "_messung-m5fenster.ts"
Cohesion: 0.10
Nodes (21): readForexCandlesArchiveFrom(), LiquidityLevel, DEFAULT_TRADE_SETUP_PARAMS, TRADE_SETUP_H1_FRACTAL_PERIOD, TRADE_SETUP_M5_FRACTAL_PERIOD, persistTradeSetupSweeps(), alarmFenster, Candle (+13 more)
...
Cohesion: 0.11
Nodes (22): businessSecondsBetween(), trendChain, trendChainDisplay, RangeTrend, ANTI_CONFLUENCE_COLOR, ANTI_CONFLUENCE_THRESHOLD, AntiConfluence, CockpitState (+14 more)

### Community 12 - "trading-monitor-mcp/index.ts"
Cohesion: 0.09
Nodes (34): toPips(), postChartAnnotations(), buildServer(), MCP_TOKEN, berlinTwinKey(), json(), withBerlinTimes(), NEXT_ACTION_FALLBACK (+26 more)
...
Cohesion: 0.07
Nodes (74): berlinDateStrFor(), berlinDateTimeStrFor(), computeHtfWatchLevels(), computeWatchLevels(), hasReaction(), isDrTrackingBusy(), appendHeartbeat(), closeLoopState() (+66 more)

### Community 15 - "TradeEditModal.vue"
Cohesion: 0.06
Nodes (39): commission, emit, entryPrice, entryTimeInput, exitPrice, exitTimeInput, instrumentMismatch, invalidationItems (+31 more)
...
Cohesion: 0.12
Nodes (29): onRemoveTarget(), addConfirmationToTrade(), addRangeConfirmation(), addTargetToTrade(), createDealingRange(), deleteDealingRange(), directionForSetup(), findMatchingTradeSetupId() (+21 more)
...
Cohesion: 0.15
Nodes (13): findClickedFibLevel(), loadInitial(), loadRangesCandles(), replayToMs(), scheduleNextRangesPoll(), startRangesPolling(), load(), usePriceChartMarketStructure() (+5 more)
...
Cohesion: 0.11
Nodes (32): ageReferenceTime(), usePriceChartLiquidity(), attachBonus(), refresh(), ageSuffix(), formatLiquidityLevelLabel(), formatLsLabel(), levelOptions() (+24 more)

### Community 62 - "barSecondsFor"
Cohesion: 0.12
Nodes (24): asOfProbeCandles(), getForexCandlesArchiveUpTo(), firstObFormationTimeAfter(), TriggerCandle, detectOrderBlocks(), HTF_FOREX_LABELS, HTF_FOREX_MIN_GAP_PIPS, LOWER_TF_LABELS (+16 more)
...
Cohesion: 0.14
Nodes (26): isBoxInvalidated(), findRecentTradeSetupIdsByKey(), getForexCandlesArchive(), getJournal(), getNewsEvents(), getTradeSetups(), getTradingAccounts(), getTradingSchedule() (+18 more)
...
Cohesion: 0.06
Nodes (73): buildLevel(), detectLiquidityLevels(), filterRelevantLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD, LIQUIDITY_MAX_RELEVANT, PIP_SIZE (+65 more)
...
### Community 95 - "fallClassifier.ts"
Cohesion: 0.08
Nodes (38): MAJOR_MIN_SECONDS, MINOR_MAX_SECONDS, AgeTier, businessSecondsBetween(), classifyAge(), computeSweepAgeHours(), MAJOR_MIN_HOURS, MAJOR_MIN_SECONDS (+30 more)
...
Cohesion: 0.15
Nodes (21): cssColor(), lineWidth(), refreshMarketStructure(), refresh(), computeTradeSetups(), bullBearLabelSide(), collectFibLevels(), collectH1LqLevels() (+13 more)
...
Cohesion: 0.12
Nodes (24): AgeTier, classifyAge(), formatAge(), obZoneCtx(), refreshTradeConfirmationLinksInternal(), refreshTradeTargetLinksInternal(), tradeLikeEntriesForCandles(), targetLabel() (+16 more)

### Community 141 - "berlinTime.ts"
Cohesion: 0.10
Nodes (25): berlinDayRangeUtcMs(), berlinOffsetMinutes(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, fetchLiveForexCandles(), fetchLiveForexCandlesOnce(), isRetryable() (+17 more)
...
### Community 148 - "Pivot"
Cohesion: 0.15
Nodes (7): Candle, ArrowPaneView, ArrowPrimitive, ArrowRenderer, FibLevel, PivotMarkerGroup, Pivot

### Community 149 - "useHttpActivity.js"
Cohesion: 0.22
Nodes (10): copiedId, { errors }, counts, dismissHttpError(), errors, extractErrorMessage(), installHttpActivityTracking(), labelFor() (+2 more)

### Community 153 - "pipScale.js"
Cohesion: 0.31
...
Cohesion: 0.10
Nodes (18): mergeCandles(), computeNextReplayTime(), isTimeCovered(), mergeRecent(), nextCandleAfter(), replayFetchToMs(), snapToBarTime(), jumpToDivergence() (+10 more)
...
Cohesion: 0.28
Nodes (8): berlinDateStrFor(), berlinDayRangeUtcMs(), berlinOffsetMinutes(), DATE_FORMATTER, formatDatedTime(), OFFSET_FORMATTER, TIME_FORMATTER, dateStr
...
### Community 170 - "marketStructureAnalysisDowntrendChoch.test.js"
Cohesion: 0.33
...
### Community 173 - "usePriceChartDrawings"
Cohesion: 0.40
Nodes (3): renderAnnotations(), usePriceChartDrawings(), refresh()

### Community 174 - "cTrader Open API as Forex Candle Source"
Cohesion: 0.40
...
## Knowledge Gaps
- **1188 isolated node(s):** `{ execFileSync }`, `path`, `TRADING_REPO`, `{ execFileSync }`, `path` (+1183 more)
...
- **Why does `businessSecondsBetween()` connect `fallClassifier.ts` to `tradeSetup.ts`, `dataExport.ts`, `validationEvidence.ts`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `marketStructureAnalysis Developer Notes` connect `Vegapunk Slimming Results (-86%)` to `fachdoku-router/SKILL.md`, `marketStructureAnalysis Rules Overview`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `LiquidityLinePrimitive`, `FibTickPrimitive`, `Pivot`, `Vegapunk Slimming Results (-86%)`, `liquidity.js`?**
