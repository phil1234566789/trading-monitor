...
## Corpus Check
- 561 files · ~570,020 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3304 nodes · 6662 edges · 184 communities (158 shown, 18 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 112 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f5ff0d7a`
...
Cohesion: 0.01
Nodes (130): useSessionStorageRef(), useTabScopedRef(), addPositionToDealingRange(), antiConfluenceAddTrade, anyArmStateActive, ARM_HINTS, ARM_STATES, armedAction (+122 more)
...
Cohesion: 0.13
Nodes (29): berlinDateStrFor(), berlinDateTimeStrFor(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, getOpenOppositeDealingRanges(), deriveStepAndCase(), loadMachineForDay() (+21 more)
...
Cohesion: 0.10
Nodes (20): 1. `period * 3600` ist die einzige harte H1-Annahme, 2. Perioden-Wahl — die eigentliche Designfrage, 3. Fenster-Anker — geklaert, Analogie traegt, 4. Pivot-Kappung — kein Volumen-, sondern ein Nachvollziehbarkeitsproblem, 5. Wo der M5-Trend hin wirkt, Anker-Korrektur, Befund: der bestehende Algo läuft auf M5-Kerzen bereits, Beides existiert im Algo bereits (+12 more)
...
Cohesion: 0.06
Nodes (44): Plan: find_targets Algorithmus, TSC-Neuaufbau Precondition, trendChain, accentStyle, antiConfluences, canTransfer, confirmationLabel(), confirmations (+36 more)
...
### Community 14 - "biasCheck.ts"
Cohesion: 0.14
Nodes (20): buildPendingDecisions(), findIntermediateLevel(), FindIntermediateLevelArgs, IntermediateLevelCandidate, isSpreadHourPivot(), PendingDecision, findNearestLiquidityTargets(), findNearestObTargets() (+12 more)
...
### Community 21 - "nearRelevantLiquidityLevels.ts"
Cohesion: 0.20
Nodes (17): berlinOffsetMinutes(), berlinOffsetFromSec(), forbiddenSessionAt(), SessionDangerConfig, PIP_SIZE, ALL_DAYS, attachRangeExtremes(), bonusLabelForPivot() (+9 more)
...
Cohesion: 0.22
Nodes (10): fetchDailyStructurePivots(), fetchAllRows(), fetchLiquidityLevelsHtf(), fetchObZones(), fetchUntouchedZones(), supabase, { data: dbDailyPivots }, { data: dbLiquidityLevelsHtf } (+2 more)

### Community 43 - "clipReplay"
Cohesion: 0.17
Nodes (27): tradesVisibleForCandles(), applyCandleData(), buildActiveMetadataSnapshotInternal(), clipReplay(), computeTradeSetupsInternal(), loadTradeSetupM5(), obZoneCtx(), refreshChart() (+19 more)
...
Cohesion: 0.06
Nodes (40): candidateLabel(), candidatePrice(), emit, mergedCandidates, precision, props, emit, OUTCOME_LABEL (+32 more)
...
### Community 92 - "recentReactions.ts"
Cohesion: 0.19
Nodes (16): getLiquidityLevels(), getObZones(), getSessions(), M5_BAR_SECONDS, M5_DETECTION_CANDLE_BUFFER, M5_DETECTION_LOOKBACK_HOURS, M5_OB_RANGE_PIPS, buildNearRelevantLiquidityLevels() (+8 more)

### Community 93 - "dataExport.ts"
Cohesion: 0.16
Nodes (18): filterRelevantLevels(), getLatestDailyStructureStartTime(), Candle, computeRangesPivots(), buildDataExport(), capStructurePivots(), coincidesWithHtf(), compute1hStructureState() (+10 more)
...
Cohesion: 0.30
Nodes (13): classifyAge(), fromPips(), byDistance(), findAntiConfluenceCandidates(), findAntiConfluenceDivergenceCandidates(), findAntiConfluenceObCandidates(), findAntiConfluenceSweepCandidates(), findInvalidationObCandidates() (+5 more)
...
Cohesion: 0.12
Nodes (30): AgeTier, classifyAge(), MAJOR_MIN_SECONDS, MINOR_MAX_SECONDS, ageReferenceTime(), businessSecondsBetween(), formatAge(), targetLabel() (+22 more)
...
### Community 153 - "cTrader Open API as Forex Candle Source"
Cohesion: 0.40
...
### Community 158 - "cssColor"
Cohesion: 0.19
Nodes (10): cssColor(), cssColorScaled(), hexToRgba(), rowStyle(), refreshDivergence(), usePriceChartTradeSetupDrawing(), refresh(), createSessionBonusResolver() (+2 more)
...
Cohesion: 0.17
Nodes (16): buildLevel(), detectLiquidityLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD, LIQUIDITY_MAX_RELEVANT, LiquidityLevel, buildCandidatePool() (+8 more)

### Community 168 - "_shared/ageTier.ts"
Cohesion: 0.24
Nodes (9): businessSecondsBetween(), computeSweepAgeHours(), MAJOR_MIN_HOURS, MAJOR_MIN_SECONDS, MINOR_MAX_HOURS, MINOR_MAX_SECONDS, ageReferenceTime(), formatAgeShort() (+1 more)
...
## Knowledge Gaps
- **1204 isolated node(s):** `{ readFileSync }`, `{ join }`, `SKILL`, `Beides existiert im Algo bereits`, `Prototyp-Ergebnis fuer den Referenzfall` (+1199 more)
...
- **Why does `businessSecondsBetween()` connect `_shared/ageTier.ts` to `tradeSetup.ts`, `liquidity.js`, `dealingRangeLoop.ts`, `dataExport.ts`, `findAntiConfluenceCandidates.js`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `marketStructureAnalysis Developer Notes` connect `Vegapunk Slimming Results (-86%)` to `fachdoku-router/SKILL.md`, `marketStructureAnalysis Rules Overview`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `fmtPrice`, `FibTickPrimitive`, `lineWidth`, `liquidity.js`, `LiquidityLinePrimitive`, `Vegapunk Slimming Results (-86%)`, `cssColor`?**
...
- **Should `Dashboard.vue` be split into smaller, more focused modules?**
  _Cohesion score 0.014957264957264958 - nodes in this community are weakly interconnected._
