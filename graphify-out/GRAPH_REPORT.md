# Graph Report - trading-monitor  (2026-09-11)

## Corpus Check
- 431 files · ~436,998 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2861 nodes · 5806 edges · 139 communities (125 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 109 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0d194a5b`
...
Cohesion: 0.02
Nodes (135): useSessionStorageRef(), useTabScopedRef(), addPositionToDealingRange(), fetchTradeSetupForCockpit(), antiConfluenceAddTrade, anyArmStateActive, ARM_STATES, clearArmStatesExcept() (+127 more)
...
Cohesion: 0.08
Nodes (40): checkFallFour(), CheckFallFourInput, computeWatchLevels(), FallFourResult, hasReaction(), HasReactionInput, hitCounterLevel(), hitTarget() (+32 more)
...
Cohesion: 0.03
Nodes (84): activeMetadataSnapshot, allCandles, antiConfluencePickerCurrentPrice, antiConfluencePickerDivergenceCandidates, antiConfluencePickerHoveredLiquidityKey, antiConfluencePickerHoveredObKey, antiConfluencePickerInvalidationObCandidates, antiConfluencePickerObCandidates (+76 more)
...
Cohesion: 0.14
Nodes (25): buildPendingDecisions(), determineTrendForce(), findIntermediateLevel(), FindIntermediateLevelArgs, IntermediateLevelCandidate, isSpreadHourPivot(), PendingDecision, TrendForceConfidence (+17 more)
...
Cohesion: 0.10
Nodes (33): AgeTier, classifyAge(), MAJOR_MIN_SECONDS, MINOR_MAX_SECONDS, ageReferenceTime(), businessSecondsBetween(), formatAge(), confirmationLabel() (+25 more)
...
Cohesion: 0.12
Nodes (32): isBoxInvalidated(), detectSetupObs(), berlinDayRangeUtcMs(), findRecentTradeSetupIdsByKey(), getForexCandlesArchive(), getJournal(), getNewsEvents(), getTradeSetups() (+24 more)
...
Cohesion: 0.17
Nodes (18): refresh(), buildLevel(), detectLiquidityLevels(), filterRelevantLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD, LIQUIDITY_MAX_RELEVANT (+10 more)
...
Cohesion: 0.11
Nodes (32): AgeTier, businessSecondsBetween(), classifyAge(), classifyInducementAge(), inducementAgeRange(), MAJOR_MIN_HOURS, MAJOR_MIN_SECONDS, MINOR_MAX_HOURS (+24 more)

### Community 29 - "orderBlocks.js"
Cohesion: 0.14
Nodes (26): emit, obZoneCtx(), onAntiConfluencePickerHover(), onAntiConfluencePickerSelect(), onTargetPickerHover(), onTargetPickerSelect(), refreshLiquidityInternal(), refreshPoiZonesInternal() (+18 more)
...
### Community 34 - "tools/pretradeGates.ts"
Cohesion: 0.10
Nodes (34): BERLIN_HM_FORMATTER, BERLIN_WEEKDAY_FORMATTER, berlinWeekdayAndMinutes(), isWithinTradingWindows(), TradingWindows, WeekdayGroup, loadOrCreateMachineForDay(), transitionIfPossible() (+26 more)
...
Cohesion: 0.09
Nodes (27): REPLAY_LOOKAHEAD_SEC M1 Scaling Gotcha, REPLAY_LOOKAHEAD_SEC M1 Scaling Bug (Origin), cachedCandlesUpTo(), cacheKey(), fetchCandlesCached(), getCachedCandles(), openDb(), safeCompleteUpTo() (+19 more)
...
Cohesion: 0.15
Nodes (26): buildActiveMetadataSnapshotInternal(), clearTradeSetupFocus(), clipReplay(), computeTradeSetupsInternal(), focusTradeSetup(), loadInitial(), loadRangesCandles(), loadTradeSetupM5() (+18 more)

### Community 50 - "FibTickPrimitive"
Cohesion: 0.15
Nodes (3): FibTickPaneView, FibTickPrimitive, FibTickRenderer

### Community 51 - "loopState.js"
Cohesion: 0.31
...
Cohesion: 0.08
Nodes (34): berlinDateTimeStrFor(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, postChartAnnotations(), buildServer(), MCP_TOKEN, getLoopStateForDay() (+26 more)
...
Cohesion: 0.06
Nodes (71): buildLevel(), detectLiquidityLevels(), filterRelevantLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD, LIQUIDITY_MAX_RELEVANT, LiquidityLevel (+63 more)
...
### Community 62 - "AntiConfluencePickerModal.vue"
Cohesion: 0.29
...
Cohesion: 0.13
Nodes (22): mergeCandles(), computeNextReplayTime(), isTimeCovered(), mergeRecent(), nextCandleAfter(), replayFetchToMs(), snapToBarTime(), jumpToDivergence() (+14 more)
...
### Community 68 - "berlinDateStrFor"
Cohesion: 0.11
Nodes (43): berlinDateStrFor(), deleteDealingRange(), fetchActiveTscRangeId(), fetchDealingRangeCockpit(), getOpenOppositeDealingRanges(), computeEvidenceScore(), EvidenceScoreBreakdownEntry, EvidenceScoreInput (+35 more)

### Community 69 - "range.type.ts"
Cohesion: 0.22
...
### Community 73 - "ClaudeAnnotationsModal.vue"
Cohesion: 0.25
...
Cohesion: 0.16
Nodes (13): fetchAlarmLog(), fetchTouchedLiquidityLevels(), fetchTradeSetups(), ALARM_TYPES, fetchDailyStructurePivots(), fetchLiquidityLevelsHtf(), fetchObZones(), fetchTouchedZones() (+5 more)
...
Cohesion: 0.12
Nodes (22): asOfProbeCandles(), firstObFormationTimeAfter(), TriggerCandle, detectOrderBlocks(), HTF_FOREX_LABELS, HTF_FOREX_MIN_GAP_PIPS, LOWER_TF_LABELS, LOWER_TF_MIN_GAP_PIPS (+14 more)
...
### Community 91 - "applyInnerMarketStructurePivot"
Cohesion: 0.25
...
Cohesion: 0.16
Nodes (8): MIN_PIXELS_PER_HOUR_FOR_LABELS Constants, canShowLabels(), MIN_PIXELS_PER_HOUR_FOR_LABELS, MIN_PIXELS_PER_HOUR_FOR_LABELS_INTRADAY, Candle, PivotMarkerGroup, PivotMarkerRenderer, RenderOptions

### Community 97 - "MetadataPanel.vue"
Cohesion: 0.24
Nodes (10): emit, height, left, onDrag(), panelEl, props, startDrag(), stopDrag() (+2 more)

### Community 98 - "TargetPickerModal.vue"
Cohesion: 0.33
Nodes (6): candidateLabel(), emit, mergedCandidates, precision, props, isTooFarFromPrice()
...
### Community 103 - "marketStructureAnalysisFib.test.js"
Cohesion: 0.29
...
### Community 106 - "usePriceChartClaudeAnnotations"
Cohesion: 0.40
...
Cohesion: 0.13
Nodes (21): cssColor(), cssColorScaled(), hexToRgba(), tradesVisibleForCandles(), refreshInvalidationLinesInternal(), refreshTradeConfirmationLinksInternal(), refreshTradeSetupLinksInternal(), refreshTradeTargetLinksInternal() (+13 more)
...
### Community 137 - "computeTrendChain"
Cohesion: 0.67
Nodes (3): trendChain, computeTrendChain(), trendOriginPivotTime()

### Community 141 - "trendChainLevelDisplay"
Cohesion: 0.25
Nodes (7): trendAlignment, trendChainDisplay, ANTI_CONFLUENCE_THRESHOLD, computeTrendAlignment(), formatTrendAge(), trendChainDepthHint(), trendChainLevelDisplay()
...
## Knowledge Gaps
- **1072 isolated node(s):** `{ execFileSync }`, `path`, `TRADING_REPO`, `trading-monitor`, `milk-city` (+1067 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 1280 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
...
- **Why does `businessSecondsBetween()` connect `liquidity.js` to `chartTimeUtils.js`, `PriceChart.vue`, `cssColor`, `computeTrendChain`, `tradeSetupCockpit.ts`, `backfillTradeSetupOutcomes.ts`?**
...
- **Should `Dashboard.vue` be split into smaller, more focused modules?**
  _Cohesion score 0.015659955257270694 - nodes in this community are weakly interconnected._
