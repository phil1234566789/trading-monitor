...
## Corpus Check
- 543 files · ~556,703 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3231 nodes · 6568 edges · 163 communities (140 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 115 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c8c2da87`
...
Cohesion: 0.11
Nodes (38): tradesVisibleForCandles(), buildActiveMetadataSnapshotInternal(), clearTradeSetupFocus(), clipReplay(), computeTradeSetupsInternal(), emit, focusTradeSetup(), loadTradeSetupM5() (+30 more)
...
Cohesion: 0.10
Nodes (34): isBoxInvalidated(), toPips(), detectSetupObs(), createDealingRange(), deleteDealingRange(), fetchActiveTscRangeId(), fetchDealingRangeCockpit(), findRecentTradeSetupIdsByKey() (+26 more)
...
### Community 19 - "db.ts"
Cohesion: 0.07
Nodes (50): addTradeConfirmation(), AddTradeConfirmationArgs, addTradePosition(), addTradeTarget(), AddTradeTargetArgs, createTrade(), CreateTradeArgs, DEALING_RANGE_FIELD_MAP (+42 more)
...
Cohesion: 0.10
Nodes (35): direction, emit, entryPrice, errorMsg, levels, props, reasoning, saving (+27 more)
...
Cohesion: 0.12
Nodes (19): minutesToTimeInput(), emit, instrumentSessions, props, WEEKDAY_DISPLAY_ORDER, refreshSessions(), addSession(), currentSessionDanger() (+11 more)
...
Cohesion: 0.09
Nodes (33): deriveStepAndCase(), LoadedMachine, loadMachineForDay(), persistTransition(), rehydrateActor(), transition(), ALL_BARS, backfillOne() (+25 more)
...
Cohesion: 0.06
Nodes (43): Plan: find_targets Algorithmus, TSC-Neuaufbau Precondition, trendChain, accentStyle, antiConfluences, canTransfer, confirmationLabel(), confirmations (+35 more)
...
### Community 52 - "validationEvidence.ts"
Cohesion: 0.15
Nodes (19): addPinEntry(), addPinM5LiquidityEntry(), addPinM5ObEntry(), addPinRsiDivergenceEntry(), getOpenOppositeDealingRanges(), getPinContext(), getPinInstrumentById(), removePinEntry() (+11 more)
...
Cohesion: 0.11
Nodes (34): berlinDayRangeUtcMs(), BERLIN_HM_FORMATTER, BERLIN_WEEKDAY_FORMATTER, berlinWeekdayAndMinutes(), isWithinTradingWindows(), TradingWindows, WeekdayGroup, buildPendingDecisions() (+26 more)
...
Cohesion: 0.13
Nodes (29): getForexCandlesArchive(), getForexCandlesArchiveUpTo(), getJournal(), getNewsEvents(), getTradeSetups(), getTradingAccounts(), getTradingSchedule(), computeEma() (+21 more)
...
Cohesion: 0.13
Nodes (22): buildLevel(), detectLiquidityLevels(), filterRelevantLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD, LIQUIDITY_MAX_RELEVANT, LiquidityLevel (+14 more)
...
Cohesion: 0.12
Nodes (28): PIP_SIZE, getLatestDailyStructureStartTime(), getObZones(), getSessions(), computeRangesPivots(), buildDataExport(), capStructurePivots(), coincidesWithHtf() (+20 more)
...
Cohesion: 0.11
Nodes (20): cssColor(), cssColorScaled(), hexToRgba(), rowStyle(), usePriceChartTradeSetupDrawing(), refresh(), fromPips(), toPips() (+12 more)
...
Cohesion: 0.13
Nodes (17): refreshMarketStructure(), bullBearLabelSide(), LiquidityLinePrimitive, Candle, ArrowPrimitive, collectFibLevels(), collectH1LqLevels(), collectNestedChain() (+9 more)
...
## Knowledge Gaps
- **1181 isolated node(s):** `SYMBOLS`, `currentSymbol`, `tradesPanelHeight`, `tradesPanelRef`, `currentBar` (+1176 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 1451 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
...
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `FibTickPrimitive`, `liquidity.js`, `Vegapunk Slimming Results (-86%)`, `lineWidth`, `cssColor`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **What connects `SYMBOLS`, `currentSymbol`, `tradesPanelHeight` to the rest of the system?**
