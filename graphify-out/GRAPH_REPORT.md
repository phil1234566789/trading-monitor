...
## Corpus Check
- 578 files · ~615,634 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3384 nodes · 6834 edges · 173 communities (150 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 120 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fcea2e9f`
...
Cohesion: 0.02
Nodes (128): useSessionStorageRef(), antiConfluenceAddTrade, anyArmStateActive, ARM_HINTS, ARM_STATES, armedAction, armedTradeAction, armedTscSection (+120 more)
...
Cohesion: 0.10
Nodes (34): berlinDateStrFor(), berlinDateTimeStrFor(), berlinOffsetMinutes(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, toPips(), buildServer() (+26 more)
...
Cohesion: 0.14
Nodes (17): Two Runtimes, One Algorithm Set (Deliberate Duplication), closesBeyondLevel(), collectObSweeps(), detectSetupObs(), detectTradeSetups(), findAllProtectedFractals(), findBestLsMatch(), findFirstSetupObAfter() (+9 more)
...
Cohesion: 0.07
Nodes (60): updateTradePosition(), FallFourResult, InducementAssessment, WatchLevel, ForceAssessment, appendHeartbeat(), closeLoopState(), HeartbeatEntry (+52 more)
...
Cohesion: 0.16
Nodes (22): emit, onAntiConfluencePickerHover(), onAntiConfluencePickerSelect(), onTargetPickerSelect(), refreshLiquidityInternal(), refreshPoiZonesInternal(), detectOrderBlocks(), OB_ZONE_KEYS (+14 more)
...
### Community 30 - "backfillTradeSetups.ts"
Cohesion: 0.15
...
Cohesion: 0.07
Nodes (10): usePriceChartTradeSetupDrawing(), refresh(), LiquidityLinePrimitive, LiquidityPaneView, TRADE_SETUP_OB_BORDER_RATIO, TRADE_SETUP_OB_FILL_RATIO, TRADE_SETUP_OB_WIDTH_SEC, ScalePaneView (+2 more)
...
Cohesion: 0.10
Nodes (22): ALARM_TYPES, berlin, container, count, error, load(), loading, fetchDailyStructurePivots() (+14 more)
...
Cohesion: 0.05
Nodes (62): CORS_HEADERS, ExistingPivotRow, INSTRUMENTS, buildLevel(), detectLiquidityLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD (+54 more)
...
Cohesion: 0.09
Nodes (18): ANNOTATION_COLOR, annotationAnchorPoint(), AnnotationsPaneView, AnnotationsPrimitive, AnnotationsRenderer, parseAnnotations(), resolveLabelPlacements(), resolveTime() (+10 more)
...
### Community 59 - "tools/pretradeGates.ts"
Cohesion: 0.14
Nodes (23): BERLIN_HM_FORMATTER, BERLIN_WEEKDAY_FORMATTER, berlinWeekdayAndMinutes(), isWithinTradingWindows(), TradingWindows, WeekdayGroup, getNewsEvents(), getTradingSchedule() (+15 more)
...
Cohesion: 0.15
Nodes (21): usePriceChartLiquidity(), attachBonus(), refresh(), buildLevel(), detectLiquidityLevels(), filterRelevantLevels(), isDownFractal(), isUpFractal() (+13 more)

### Community 62 - "biasCheck.ts"
Cohesion: 0.20
Nodes (16): buildPendingDecisions(), findIntermediateLevel(), FindIntermediateLevelArgs, IntermediateLevelCandidate, isSpreadHourPivot(), PendingDecision, buildCandidatePool(), findNearestLiquidityTargets() (+8 more)
...
Cohesion: 0.14
Nodes (23): cssColor(), refreshM5Structure(), refreshMarketStructure(), structureRenderOptions(), Candle, collectNestedChain(), deriveTrendReaction(), ArrowPrimitive (+15 more)
...
Cohesion: 0.06
Nodes (65): fetchAllRows(), filterRelevantLevels(), PIP_SIZE, DailyPivotLike, ALL_DAYS, attachRangeExtremes(), bonusLabelForPivot(), buildSessionContextLookup() (+57 more)

### Community 121 - "backfillObZones.ts"
Cohesion: 0.29
...
Cohesion: 0.15
Nodes (22): riskPips, labelMitQuote(), fromPips(), toPips(), KEINE_SKALA, PIP_SCALE_HIGHLIGHT, PIP_SCALE_STEPS, pipScaleLevels() (+14 more)
...
Cohesion: 0.07
Nodes (35): cssColorScaled(), hexToRgba(), candidateLabel(), candidatePrice(), emit, mergedCandidates, precision, props (+27 more)
...
Cohesion: 0.15
Nodes (16): marketStructureTree, M5_STRUCTURE_STYLE_KEYS, usePriceChartMarketStructure(), computeRangesPivotsAndMetadata(), computeRangesPivotsFor(), refreshRangesMarkers(), buildMarketStructureState(), computeRangesPivots() (+8 more)
...
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `usePriceChartTradeSetupDrawing.js`, `liquidity.js`, `usePriceChartMarketStructure.js`, `lineWidth`, `FibTickPrimitive`, `Vegapunk Slimming Results (-86%)`?**
...
- **Should `Dashboard.vue` be split into smaller, more focused modules?**
  _Cohesion score 0.01500513874614594 - nodes in this community are weakly interconnected._
