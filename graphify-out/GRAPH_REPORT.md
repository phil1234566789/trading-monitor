...
## Corpus Check
- 564 files · ~573,158 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3338 nodes · 6734 edges · 174 communities (153 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 115 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6bc59eba`
...
2. `cssColor()` - 38 edges
3. `berlinDateTimeStrFor()` - 34 edges
4. `fmtPrice()` - 34 edges
...
Cohesion: 0.01
Nodes (132): useSessionStorageRef(), useTabScopedRef(), addPositionToDealingRange(), antiConfluenceAddTrade, anyArmStateActive, ARM_HINTS, ARM_STATES, armedAction (+124 more)
...
Cohesion: 0.10
Nodes (27): REPLAY_LOOKAHEAD_SEC M1 Scaling Gotcha, REPLAY_LOOKAHEAD_SEC M1 Scaling Bug (Origin), cachedCandlesUpTo(), cacheKey(), fetchCandlesCached(), getCachedCandles(), hasLargeCandleGap(), mergeCandles() (+19 more)

### Community 3 - "trading-monitor-mcp/index.ts"
Cohesion: 0.13
Nodes (26): toPips(), deleteDealingRange(), postChartAnnotations(), buildServer(), MCP_TOKEN, json(), deprecatedTimeParam(), ANNOTATION_SCHEMA (+18 more)
...
Cohesion: 0.16
Nodes (21): berlinOffsetMinutes(), berlinOffsetFromSec(), forbiddenSessionAt(), SessionDangerConfig, ALL_DAYS, attachRangeExtremes(), bonusLabelForPivot(), buildSessionContextLookup() (+13 more)
...
Cohesion: 0.05
Nodes (47): trendChain, accentStyle, antiConfluences, canTransfer, confirmationLabel(), confirmations, confluences, dateLabel (+39 more)
...
Cohesion: 0.15
Nodes (18): marketStructureTree, M5_STRUCTURE_STYLE_KEYS, usePriceChartMarketStructure(), computeRangesPivotsAndMetadata(), computeRangesPivotsFor(), refreshM5Structure(), refreshMarketStructure(), structureRenderOptions() (+10 more)
...
Cohesion: 0.09
Nodes (34): HTF_FOREX_MIN_GAP_PIPS Constant, LOWER_TF_MIN_GAP_PIPS Constant, Pip-/Pixel-Schwellwerte Übersicht, PIP_SIZE Constant, RANGE_FIB_MIN_PP_DISTANCE_PIPS Constant, TRADE_SETUP_LS_MAX_DISTANCE_M5 Constant, poi-watcher 4H+1H OB-Zonen-Wächter Edge Function, openAntiConfluencePicker() (+26 more)
...
### Community 25 - "applyInnerMarketStructurePivot"
Cohesion: 0.13
Nodes (13): advanceNestedTrendInner(), applyInnerMarketStructurePivot(), confirmBreak, originHigh, originLow, pullback, baseState(), candles (+5 more)
...
Cohesion: 0.08
Nodes (28): PivotMarkerGroup, ClosedRange, MarketStructureState, Pivot, PivotBase, PivotHigh, PivotLow, PivotTouched (+20 more)
...
Cohesion: 0.13
Nodes (9): computeNextReplayTime(), formatAge(), mergeRecent(), nextCandleAfter(), replayFetchToMs(), snapToBarTime(), ScalePaneView, ScalePrimitive (+1 more)

### Community 36 - "tdd_mit_claude.ts"
Cohesion: 0.08
Nodes (24): nextPivot1, nextPivot10, nextPivot11, nextPivot2, nextPivot3, nextPivot4, nextPivot5, nextPivot6 (+16 more)

### Community 37 - "TargetPickerModal.vue"
Cohesion: 0.16
...
### Community 41 - "dataSnapshot.ts"
Cohesion: 0.11
Nodes (29): isBoxInvalidated(), detectSetupObs(), fetchActiveTscRangeId(), fetchDealingRangeCockpit(), findRecentTradeSetupIdsByKey(), getObZones(), getOpenOppositeDealingRanges(), getSessions() (+21 more)
...
Cohesion: 0.10
Nodes (40): tradesVisibleForCandles(), applyCandleData(), buildActiveMetadataSnapshotInternal(), clearTradeSetupFocus(), clipReplay(), computeTradeSetupsInternal(), emit, focusTradeSetup() (+32 more)
...
Cohesion: 0.11
Nodes (24): onAntiConfluencePickerHover(), liquidityLevelNaturalKey(), liquidityLevelEntryNaturalKey(), m5LiquidityEntryNaturalKey(), obZoneEntryNaturalKey(), confirmationLiquidityKeys, hoveredPinLiquidityLevelKey, hoveredPinObZoneKey (+16 more)
...
Cohesion: 0.12
Nodes (29): ageReferenceTime(), businessSecondsBetween(), usePriceChartLiquidity(), attachBonus(), refresh(), ageSuffix(), formatLiquidityLevelLabel(), formatLsLabel() (+21 more)

### Community 62 - "barSecondsFor"
Cohesion: 0.15
Nodes (21): asOfProbeCandles(), dropLowerTfDuplicates(), filterRelevantRows(), getLiquidityLevels(), firstObFormationTimeAfter(), TriggerCandle, applyAsOf(), applyAsOfZones() (+13 more)
...
Cohesion: 0.06
Nodes (38): cssColorScaled(), hexToRgba(), candidateLabel(), candidatePrice(), emit, mergedCandidates, precision, props (+30 more)
...
Cohesion: 0.07
Nodes (51): formatDatedTime(), formatPips(), MEASURE_COLOR, measureDrawing(), tabelle, FVG_BAENDER, FVG_BAND_LABELS, FVG_BAND_N (+43 more)

### Community 92 - "marketStructureRendering.ts"
Cohesion: 0.15
Nodes (21): bullBearLabelSide(), collectNestedChain(), collectFibLevels(), collectStructureLqLevels(), computeFibLevels(), fibBetween(), FibLevel, firstCloseBelow() (+13 more)

### Community 93 - "dataExport.ts"
Cohesion: 0.15
Nodes (18): getLatestDailyStructureStartTime(), computeRangesPivots(), pivotForDisplay(), summarizeMarketStructureState(), buildDataExport(), capStructurePivots(), compute1hStructureState(), computeTrendChainAges() (+10 more)
...
Cohesion: 0.18
Nodes (19): businessSecondsBetween(), classifyAge(), computeSweepAgeHours(), MAJOR_MIN_HOURS, MAJOR_MIN_SECONDS, MINOR_MAX_HOURS, MINOR_MAX_SECONDS, fromPips() (+11 more)
...
Cohesion: 0.15
Nodes (10): CORS_HEADERS, ExistingPivotRow, INSTRUMENTS, PIP_SIZE, DailyPivotLike, resolveStructureStartTime(), HTF_FOREX_LABELS, HTF_FOREX_MIN_GAP_PIPS (+2 more)
...
Cohesion: 0.15
Nodes (6): Candle, PivotMarkerPaneView, PivotMarkerPrimitive, PivotMarkerRenderer, RenderOptions, renderPivotMarkers()

### Community 134 - "cTrader Open API as Forex Candle Source"
Cohesion: 0.40
...
Cohesion: 0.15
Nodes (18): filterRelevantLevels(), buildCandidatePool(), DEFAULT_LIQUIDITY_TARGET_LIMIT, DEFAULT_OB_TARGET_LIMIT, findNearestLiquidityTargets(), findNearestObTargets(), findTargetCandidates(), isTooFarFromPrice() (+10 more)
...
Cohesion: 0.23
Nodes (10): cssColor(), refreshRangesMarkers(), nativeLineWidth(), usePriceChartRsi(), applyColorOptions(), applyLineWidthOptions(), create(), refreshEma() (+2 more)

### Community 179 - "liquidityDetection.ts"
Cohesion: 0.12
Nodes (18): buildLevel(), detectLiquidityLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD, LIQUIDITY_MAX_RELEVANT, backfillOne(), BAR_CONFIG (+10 more)
...
## Knowledge Gaps
- **1222 isolated node(s):** `Beides existiert im Algo bereits`, `Prototyp-Ergebnis fuer den Referenzfall`, `Warum der 1h-Nested noch bullisch ist`, `Befund: der bestehende Algo läuft auf M5-Kerzen bereits`, `1. `period * 3600` ist die einzige harte H1-Annahme` (+1217 more)
...
- **Why does `businessSecondsBetween()` connect `findAntiConfluenceCandidates.js` to `nearRelevantLiquidityLevels.ts`, `tradeSetup.ts`, `tradeEvidence.ts`, `biasCheck.ts`, `dealingRangeLoop.ts`, `dataExport.ts`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `marketStructureAnalysis Developer Notes` connect `Vegapunk Slimming Results (-86%)` to `fachdoku-router/SKILL.md`, `marketStructureAnalysis Rules Overview`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `lineWidth`, `LiquidityLinePrimitive`, `FibTickPrimitive`, `cssColor`, `usePriceChartMarketStructure.js`, `Vegapunk Slimming Results (-86%)`, `ArrowPrimitive`, `RangeLinePrimitive`, `liquidity.js`?**
...
- **Should `Dashboard.vue` be split into smaller, more focused modules?**
  _Cohesion score 0.014643363249881908 - nodes in this community are weakly interconnected._
