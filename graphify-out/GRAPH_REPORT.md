...
## Corpus Check
- 576 files · ~615,081 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3380 nodes · 6818 edges · 189 communities (165 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 120 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `41ea8f24`
...
Cohesion: 0.02
Nodes (123): useSessionStorageRef(), antiConfluenceAddTrade, anyArmStateActive, ARM_HINTS, ARM_STATES, armedAction, armedTradeAction, armedTscSection (+115 more)
...
Cohesion: 0.11
Nodes (25): REPLAY_LOOKAHEAD_SEC M1 Scaling Gotcha, REPLAY_LOOKAHEAD_SEC M1 Scaling Bug (Origin), cachedCandlesUpTo(), cacheKey(), fetchCandlesCached(), getCachedCandles(), hasLargeCandleGap(), openDb() (+17 more)

### Community 3 - "berlinDateTimeStrFor"
Cohesion: 0.10
Nodes (32): berlinDateTimeStrFor(), toPips(), buildServer(), MCP_TOKEN, berlinTwinKey(), json(), withBerlinTimes(), getLoopStateForDay() (+24 more)

### Community 4 - "PriceChart.vue"
Cohesion: 0.03
Nodes (78): PIP_SIZE Constant, TRADE_SETUP_LS_MAX_DISTANCE_M5 Constant, mergeRecent(), activeMetadataSnapshot, allCandles, antiConfluencePickerCurrentPrice, antiConfluencePickerDivergenceCandidates, antiConfluencePickerHoveredLiquidityKey (+70 more)
...
Cohesion: 0.11
Nodes (36): cssColorScaled(), hexToRgba(), tradesVisibleForCandles(), applyCandleData(), buildActiveMetadataSnapshotInternal(), clearTradeSetupFocus(), clipReplay(), computeTradeSetupsInternal() (+28 more)
...
### Community 14 - "canShowLabels"
Cohesion: 0.21
Nodes (5): drawIconLabel(), canShowLabels(), positionsBox(), DivergenceLineRenderer, mergePinnedDivergences()

### Community 15 - "TradeEditModal.vue"
Cohesion: 0.06
Nodes (43): commission, emit, entryPrice, entryTimeInput, exitPrice, exitTimeInput, instrumentMismatch, invalidationItems (+35 more)
...
Cohesion: 0.12
Nodes (31): buildPendingDecisions(), findIntermediateLevel(), FindIntermediateLevelArgs, IntermediateLevelCandidate, isSpreadHourPivot(), PendingDecision, findNearestLiquidityTargets(), findNearestObTargets() (+23 more)
...
Cohesion: 0.13
Nodes (27): emit, onAntiConfluencePickerHover(), onAntiConfluencePickerSelect(), onTargetPickerHover(), onTargetPickerSelect(), openAntiConfluencePicker(), openTargetPicker(), refreshLiquidityInternal() (+19 more)
...
Cohesion: 0.19
Nodes (18): addConfirmationToTrade(), addRangeConfirmation(), addTargetToTrade(), createDealingRange(), directionForSetup(), findMatchingTradeSetupId(), findOrCreateLiquidityLevelId(), insertConfirmation() (+10 more)
...
### Community 35 - "usePriceChartTradeSetupDrawing.js"
Cohesion: 0.12
Nodes (8): usePriceChartTradeSetupDrawing(), refresh(), TRADE_SETUP_OB_BORDER_RATIO, TRADE_SETUP_OB_FILL_RATIO, TRADE_SETUP_OB_WIDTH_SEC, ScalePaneView, ScalePrimitive, ScaleRenderer

### Community 36 - "tdd_mit_claude.ts"
Cohesion: 0.08
Nodes (24): nextPivot1, nextPivot10, nextPivot11, nextPivot2, nextPivot3, nextPivot4, nextPivot5, nextPivot6 (+16 more)

### Community 37 - "chartMeasure.js"
Cohesion: 0.52
...
### Community 40 - "findAntiConfluences.js"
Cohesion: 0.35
Nodes (12): berlinDateStrFor(), byDistance(), findAntiConfluenceCandidates(), findAntiConfluenceDivergenceCandidates(), findAntiConfluenceObCandidates(), findAntiConfluenceSweepCandidates(), findInvalidationObCandidates(), inBand() (+4 more)
...
Cohesion: 0.10
Nodes (22): berlin, container, count, error, load(), loading, fetchDailyStructurePivots(), DB_READ_PAGE_SIZE (+14 more)
...
Cohesion: 0.14
Nodes (13): ANNOTATION_COLOR, annotationAnchorPoint(), AnnotationsRenderer, resolveLabelPlacements(), resolveTime(), VALID_TYPES, berlinDayRangeUtcMs(), berlinOffsetMinutes() (+5 more)
...
### Community 60 - "db.ts"
Cohesion: 0.09
Nodes (34): addTradeConfirmation(), AddTradeConfirmationArgs, addTradePosition(), addTradeTarget(), AddTradeTargetArgs, createTrade(), CreateTradeArgs, DEALING_RANGE_FIELD_MAP (+26 more)

### Community 61 - "liquidity.js"
Cohesion: 0.05
Nodes (57): Two Runtimes, One Algorithm Set (Deliberate Duplication), ageReferenceTime(), businessSecondsBetween(), formatAge(), usePriceChartLiquidity(), attachBonus(), refresh(), computeTradeSetups() (+49 more)
...
### Community 67 - "cssColor"
Cohesion: 0.21
Nodes (12): cssColor(), nativeLineWidth(), usePriceChartRsi(), applyColorOptions(), applyLineWidthOptions(), create(), refreshEma(), refreshRsi() (+4 more)
...
Cohesion: 0.06
Nodes (41): advanceNestedTrendInner(), applyInnerMarketStructurePivot(), applyMarketStructurePivot(), initMarketStructureState(), pivot1, pivot2, pivot3, pivot4 (+33 more)
...
Cohesion: 0.14
Nodes (20): removeDrawing(), toggleDrawingVisible(), add(), currentSymbol, dateStr, drawings, flatAnnotations, instrument (+12 more)
...
Cohesion: 0.09
Nodes (27): Candle, collectNestedChain(), ArrowPrimitive, collectFibLevels(), collectStructureLqLevels(), computeFibLevels(), fibBetween(), FibLevel (+19 more)

### Community 93 - "dataSnapshot.ts"
Cohesion: 0.15
Nodes (23): isBoxInvalidated(), detectSetupObs(), findRecentTradeSetupIdsByKey(), getForexCandlesArchiveUpTo(), getObZones(), getSessions(), fetchForexCandles(), fetchLiveForexCandles() (+15 more)
...
### Community 104 - "chartTimeUtils.test.js"
Cohesion: 0.16
Nodes (13): mergeCandles(), computeNextReplayTime(), isTimeCovered(), nextCandleAfter(), jumpToDivergence(), jumpToPin(), jumpToTimeRange(), jumpToTrade() (+5 more)

### Community 105 - "snapToBarTime"
Cohesion: 0.13
...
Cohesion: 0.14
Nodes (23): buildLevel(), detectLiquidityLevels(), filterRelevantLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_MAX_RELEVANT, getLatestDailyStructureStartTime(), Candle (+15 more)
...
Cohesion: 0.12
Nodes (14): ArchivableCandle, readForexCandlesArchiveFrom(), LiquidityLevel, DEFAULT_TRADE_SETUP_PARAMS, TRADE_SETUP_H1_FRACTAL_PERIOD, TRADE_SETUP_M5_FRACTAL_PERIOD, persistTradeSetupSweeps(), alarmFenster (+6 more)

### Community 146 - "nearRelevantLiquidityLevels.ts"
Cohesion: 0.22
...
### Community 149 - "DrawingsModal.vue"
Cohesion: 0.20
...
### Community 158 - "findTargetCandidates.js"
Cohesion: 0.18
Nodes (13): buildCandidatePool(), DEFAULT_LIQUIDITY_TARGET_LIMIT, DEFAULT_OB_TARGET_LIMIT, findTargetCandidates(), isTooFarFromPrice(), MAX_TARGET_DISTANCE_PIPS, M5_BAR_SECONDS, M5_DETECTION_CANDLE_BUFFER (+5 more)
...
### Community 166 - "loopState.ts"
Cohesion: 0.15
Nodes (14): closeLoopState(), HeartbeatEntry, LoopStatus, rowToState(), TradingLoopStateRow, UPDATE_FIELD_MAP, updateLoopState(), UpdateLoopStateArgs (+6 more)
...
### Community 173 - "berlinTime.ts"
Cohesion: 0.18
Nodes (10): DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, ALL_BARS, backfillOne(), Bar, BARS, INSTRUMENTS (+2 more)

### Community 174 - "berlinDateStrFor"
Cohesion: 0.11
Nodes (40): berlinDateStrFor(), addPinEntry(), addPinM5LiquidityEntry(), addPinM5ObEntry(), addPinRsiDivergenceEntry(), createDealingRange(), deleteDealingRange(), fetchActiveTscRangeId() (+32 more)

### Community 175 - "trading-monitor-mcp/orderBlockDetection.js"
Cohesion: 0.23
Nodes (8): firstObFormationTimeAfter(), TriggerCandle, detectOrderBlocks(), HTF_FOREX_LABELS, HTF_FOREX_MIN_GAP_PIPS, LOWER_TF_LABELS, LOWER_TF_MIN_GAP_PIPS, candles
...
### Community 186 - "toDatetimeLocal"
Cohesion: 0.50
Nodes (4): rangesFixedStartInputValue, rangesPivotStartDisplay, replayInputValue, toDatetimeLocal()

### Community 187 - "addPositionToDealingRange"
Cohesion: 0.67
Nodes (3): addPositionToDealingRange(), confirmationAnchorTime(), onTscTransferToTrades()

### Community 188 - "editingTradeAsRange"
Cohesion: 0.67
Nodes (3): editingTradeAsRange(), onOpenTradeAntiConfluencePicker(), onOpenTradeTargetPicker()
...
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `cssColor`, `usePriceChartMarketStructure.js`, `lineWidth`, `FibTickPrimitive`, `LiquidityLinePrimitive`, `Vegapunk Slimming Results (-86%)`, `liquidity.js`?**
...
- **Should `Dashboard.vue` be split into smaller, more focused modules?**
  _Cohesion score 0.015146489773355445 - nodes in this community are weakly interconnected._
