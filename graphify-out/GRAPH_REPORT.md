...
## Corpus Check
- 401 files · ~423,936 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2787 nodes · 5601 edges · 124 communities (115 shown, 7 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 110 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca60b6ac`
...
Cohesion: 0.08
Nodes (62): berlinDateStrFor(), computeWatchLevels(), appendHeartbeat(), closeLoopState(), getActiveLoopState(), HeartbeatEntry, LoopLevel, LoopStatus (+54 more)

### Community 3 - "dataExport.ts"
Cohesion: 0.05
Nodes (79): berlinDateTimeStrFor(), berlinDayRangeUtcMs(), berlinOffsetMinutes(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, buildPendingDecisions(), determineTrendForce() (+71 more)
...
Cohesion: 0.07
Nodes (41): cssColor(), cssColorScaled(), hexToRgba(), tradesVisibleForCandles(), refreshInvalidationLinesInternal(), refreshTradeConfirmationLinksInternal(), refreshTradeSetupLinksInternal(), refreshTradeTargetLinksInternal() (+33 more)

### Community 20 - "forexCandles.ts"
Cohesion: 0.14
Nodes (18): getForexCandlesArchiveUpTo(), BAR_SECONDS, barSecondsFor(), Candle, fetchLiveForexCandles(), fetchLiveForexCandlesOnce(), isRetryable(), ALL_BARS (+10 more)
...
Cohesion: 0.08
Nodes (38): CORS_HEADERS, CORS_HEADERS, ExistingPivotRow, INSTRUMENTS, CORS_HEADERS, PERIOD_MAP, PERSISTABLE_BARS, persistIfArchivable() (+30 more)
...
Cohesion: 0.10
Nodes (40): buildLevel(), detectLiquidityLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD, LIQUIDITY_MAX_RELEVANT, LiquidityLevel, advanceNestedTrend() (+32 more)
...
### Community 50 - "Pivot"
Cohesion: 0.13
Nodes (8): FibLevel, Candle, PivotMarkerGroup, PivotMarkerPaneView, PivotMarkerPrimitive, PivotMarkerRenderer, RenderOptions, Pivot

### Community 51 - "MetadataPanel.vue"
Cohesion: 0.05
Nodes (40): emit, height, left, onDrag(), panelEl, props, startDrag(), stopDrag() (+32 more)
...
Cohesion: 0.10
Nodes (37): filterRelevantLevels(), createDealingRange(), deleteDealingRange(), fetchActiveTscRangeId(), fetchDealingRangeCockpit(), getOpenOppositeDealingRanges(), toLiquidityLevel(), computeEvidenceScore() (+29 more)
...
Cohesion: 0.20
Nodes (15): buildLevel(), detectLiquidityLevels(), isDownFractal(), isUpFractal(), LiquidityLevel, isBoxInvalidated(), DEFAULT_TRADE_SETUP_PARAMS, DetectedTradeSetup (+7 more)
...
## Knowledge Gaps
- **1044 isolated node(s):** `PretradeGatesArgs`, `PretradeGatesResult`, `CandleRow`, `ClassifiedDivergence`, `SessionOcc` (+1039 more)
...
- **What connects `PretradeGatesArgs`, `PretradeGatesResult`, `CandleRow` to the rest of the system?**
