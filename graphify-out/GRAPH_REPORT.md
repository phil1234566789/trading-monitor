...
## Corpus Check
- 533 files · ~520,746 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3209 nodes · 6510 edges · 159 communities (141 shown, 10 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 117 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `62143322`
...
Cohesion: 0.02
Nodes (121): useSessionStorageRef(), useTabScopedRef(), addPositionToDealingRange(), antiConfluenceAddTrade, anyArmStateActive, ARM_STATES, closeTradeEditModal(), confirmationAddTrade (+113 more)
...
Cohesion: 0.12
Nodes (33): berlinDateStrFor(), createDealingRange(), deleteDealingRange(), buildServer(), MCP_TOKEN, berlinTwinKey(), json(), withBerlinTimes() (+25 more)

### Community 8 - "usePriceChartRsi.js"
Cohesion: 0.05
Nodes (49): nativeLineWidth(), usePriceChartRsi(), applyColorOptions(), applyLineWidthOptions(), create(), refreshDivergence(), refreshEma(), refreshRsi() (+41 more)
...
Cohesion: 0.07
Nodes (43): assessInducement(), computeHtfWatchLevels(), computeWatchLevels(), FallFourResult, hasReaction(), isDrTrackingBusy(), WatchLevel, ForceAssessment (+35 more)
...
Cohesion: 0.11
Nodes (25): cssColor(), cssColorScaled(), hexToRgba(), trendChain, rowStyle(), refresh(), RangeTrend, ANTI_CONFLUENCE_COLOR (+17 more)
...
Cohesion: 0.07
Nodes (27): Plan: find_targets Algorithmus, TSC-Neuaufbau Precondition, emit, emit, accentStyle, antiConfluences, canTransfer, confirmations (+19 more)
...
Cohesion: 0.18
Nodes (12): ALARM_TYPES, fetchDailyStructurePivots(), DB_READ_PAGE_SIZE, fetchAllRows(), fetchLiquidityLevelsHtf(), fetchObZones(), fetchUntouchedZones(), supabase (+4 more)
...
Cohesion: 0.06
Nodes (40): usePriceChartTradeSetupDrawing(), HTF_FOREX_LABELS, HTF_FOREX_MIN_GAP_PIPS, LOWER_TF_LABELS, LOWER_TF_MIN_GAP_PIPS, PIP_SIZE, toPips(), CALLOUT_STACK_GAP_PX (+32 more)

### Community 46 - "berlinTime.ts"
Cohesion: 0.10
Nodes (28): berlinOffsetMinutes(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, PIP_SIZE, toPips(), ALL_DAYS, attachRangeExtremes() (+20 more)
...
### Community 51 - "orderBlocks.js"
Cohesion: 0.11
Nodes (11): MIN_PIXELS_PER_HOUR_FOR_LABELS Constants, drawIconLabel(), canShowLabels(), MIN_PIXELS_PER_HOUR_FOR_LABELS, MIN_PIXELS_PER_HOUR_FOR_LABELS_INTRADAY, OB_ZONE_KEYS, positionsBox(), renderPersistedZones() (+3 more)
...
Cohesion: 0.12
Nodes (30): buildPendingDecisions(), findIntermediateLevel(), FindIntermediateLevelArgs, IntermediateLevelCandidate, isSpreadHourPivot(), PendingDecision, deriveStepAndCase(), LoadedMachine (+22 more)
...
### Community 59 - "TargetPickerModal.vue"
Cohesion: 0.15
Nodes (16): MAX_TARGET_DISTANCE_PIPS Constant, find_targets Target-Candidate Algorithm Design, openAntiConfluencePicker(), openTargetPicker(), candidateLabel(), emit, mergedCandidates, precision (+8 more)
...
Cohesion: 0.14
Nodes (20): marketStructureTree, usePriceChartLiquidity(), attachBonus(), refresh(), liquidityLevelNaturalKey(), renderLiquidityLevels(), LIQUIDITY_FRACTAL_PERIOD, selectRelevantHtfLevels() (+12 more)
...
Cohesion: 0.10
Nodes (30): MAJOR_MIN_SECONDS, MINOR_MAX_SECONDS, AgeTier, businessSecondsBetween(), classifyAge(), computeSweepAgeHours(), MAJOR_MIN_HOURS, MAJOR_MIN_SECONDS (+22 more)
...
### Community 86 - "Fachdoku-Router Skill"
Cohesion: 0.15
...
### Community 91 - "Pip-/Pixel-Schwellwerte Übersicht"
Cohesion: 0.32
...
Cohesion: 0.06
Nodes (67): compressed, root, rows, targets, trends, worker(), berlinDateTimeStrFor(), fetchAllRows() (+59 more)
...
### Community 95 - "LiquidityLinePrimitive"
Cohesion: 0.14
...
### Community 104 - "applyInnerMarketStructurePivot"
Cohesion: 0.25
...
Cohesion: 0.11
Nodes (21): refreshMarketStructure(), bullBearLabelSide(), Candle, ArrowPrimitive, collectFibLevels(), collectH1LqLevels(), collectNestedChain(), computeFibLevels() (+13 more)
...
### Community 108 - "usePriceChartTradeSetups"
Cohesion: 0.33
...
### Community 131 - "detectLiquidityLevels"
Cohesion: 0.53
...
Cohesion: 0.11
Nodes (30): AgeTier, classifyAge(), ageReferenceTime(), businessSecondsBetween(), formatAge(), confirmationLabel(), targetLabel(), confirmationLabel() (+22 more)
...
### Community 148 - "initMarketStructureState"
Cohesion: 0.14
...
- **Why does `businessSecondsBetween()` connect `fallClassifier.ts` to `tradeSetup.ts`, `dataExport.ts`, `dealingRangeLoop.ts`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `marketStructureAnalysis Developer Notes` connect `Vegapunk Slimming Results (-86%)` to `fachdoku-router/SKILL.md`, `marketStructureAnalysis Rules Overview`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `tradeSetupCockpit.ts`, `liquidity.js`, `FibTickPrimitive`, `Vegapunk Slimming Results (-86%)`, `lineWidth`, `LiquidityLinePrimitive`?**
...
- **Should `Dashboard.vue` be split into smaller, more focused modules?**
  _Cohesion score 0.01579520697167756 - nodes in this community are weakly interconnected._
