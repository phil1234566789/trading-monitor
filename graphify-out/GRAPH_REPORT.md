...
Cohesion: 0.06
Nodes (59): berlinDateStrFor(), berlinDateTimeStrFor(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, computeWatchLevels(), appendHeartbeat(), closeLoopState() (+51 more)
...
Cohesion: 0.09
Nodes (22): refreshMarketStructure(), Candle, ArrowPaneView, ArrowPrimitive, ArrowRenderer, collectFibLevels(), collectH1LqLevels(), collectNestedChain() (+14 more)
...
Cohesion: 0.09
Nodes (44): buildPendingDecisions(), determineTrendForce(), findIntermediateLevel(), FindIntermediateLevelArgs, IntermediateLevelCandidate, isSpreadHourPivot(), PendingDecision, TrendForceConfidence (+36 more)
...
Cohesion: 0.22
Nodes (13): computeLiquidityLevelsForExport(), formatLiquidityLevel(), ALL_DAYS, attachRangeExtremes(), bonusLabelForPivot(), buildSessionContextLookup(), contextForPivot(), daysOrAll() (+5 more)
...
Cohesion: 0.12
Nodes (24): AgeTier, classifyAge(), MAJOR_MIN_SECONDS, MINOR_MAX_SECONDS, formatAge(), refreshTradeConfirmationLinksInternal(), confirmationLabel(), targetLabel() (+16 more)
...
Cohesion: 0.11
Nodes (33): isBoxInvalidated(), detectSetupObs(), berlinDayRangeUtcMs(), fetchDealingRangeCockpit(), findRecentTradeSetupIdsByKey(), getForexCandlesArchive(), getJournal(), getTradeSetups() (+25 more)
...
Cohesion: 0.08
Nodes (21): chartColors, cssColorScaled(), DEFAULT_CHART_COLORS, hexToRgba(), resetChartColors(), chartLineWidths, DEFAULT_CHART_LINE_WIDTHS, resetChartLineWidths() (+13 more)
...
Cohesion: 0.07
Nodes (50): AgeTier, businessSecondsBetween(), classifyAge(), classifyInducementAge(), inducementAgeRange(), MAJOR_MIN_HOURS, MAJOR_MIN_SECONDS, MINOR_MAX_HOURS (+42 more)

### Community 29 - "priceChartObZones.js"
Cohesion: 0.17
Nodes (23): emit, obZoneCtx(), onAntiConfluencePickerHover(), onAntiConfluencePickerSelect(), onTargetPickerHover(), onTargetPickerSelect(), refreshLiquidityInternal(), refreshPoiZonesInternal() (+15 more)
...
### Community 34 - "clearArmStatesExcept"
Cohesion: 0.15
...
Cohesion: 0.08
Nodes (46): buildLevel(), detectLiquidityLevels(), filterRelevantLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD, LIQUIDITY_MAX_RELEVANT, LiquidityLevel (+38 more)
...
Cohesion: 0.09
Nodes (32): REPLAY_LOOKAHEAD_SEC M1 Scaling Gotcha, REPLAY_LOOKAHEAD_SEC M1 Scaling Bug (Origin), cachedCandlesUpTo(), cacheKey(), fetchCandlesCached(), getCachedCandles(), mergeCandles(), openDb() (+24 more)
...
Cohesion: 0.08
Nodes (47): dropLowerTfDuplicates(), fetchAllRows(), filterRelevantRows(), getLiquidityLevels(), getObZones(), getOpenOppositeDealingRanges(), computeEvidenceScore(), EvidenceScoreBreakdownEntry (+39 more)
...
Cohesion: 0.05
Nodes (17): MIN_PIXELS_PER_HOUR_FOR_LABELS Constants, drawIconLabel(), canShowLabels(), MIN_PIXELS_PER_HOUR_FOR_LABELS, MIN_PIXELS_PER_HOUR_FOR_LABELS_INTRADAY, LiquidityLineRenderer, positionsBox(), Candle (+9 more)
...
Cohesion: 0.07
Nodes (34): candidateLabel(), candidatePrice(), emit, mergedCandidates, precision, props, emit, OUTCOME_LABEL (+26 more)
...
Cohesion: 0.11
Nodes (23): cssColor(), lineWidth(), ageReferenceTime(), businessSecondsBetween(), tradesVisibleForCandles(), refreshInvalidationLinesInternal(), refreshTradeSetupLinksInternal(), refreshTradeTargetLinksInternal() (+15 more)
...
## Knowledge Gaps
- **1073 isolated node(s):** `a) Aufmerksamkeitslevel niedrig — kein DR, Markt gibt nichts her (Fall 3)`, `b) Aufmerksamkeitslevel hoch — Dealing Range bildet sich (Fall 2)`, `c) Aufmerksamkeitslevel hoch — Dealing Range bestätigt (Fall 1)`, `d) Aufmerksamkeitslevel höchste — Dealing Range validiert (Schritt 7, Find Entry)`, `Bekannter Bug (07.09.2026, behoben)` (+1068 more)
...
- **Why does `businessSecondsBetween()` connect `liquidity.js` to `chartTimeUtils.js`, `pricePrecisionForInstrument`, `PriceChart.vue`, `computeTrendChain`, `tradeEvidence.ts`, `tradeSetupCockpit.ts`, `backfillTradeSetupOutcomes.ts`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `Trading-Monitor Project Overview (CLAUDE.md)` connect `Trading-Monitor Project Overview (CLAUDE.md)` to `chartTimeUtils.js`, `Plan: Forex-Chart-Objekte Datengrundlage`, `/task do Mode`, `cTrader Open API as Forex Candle Source`, `Plan: POI-Strategie-Findung, Backtesting & Trade-Notifications`, `Fachdoku-Router Skill`, `Plan: Sehr Große Dateien Refactoren (PriceChart.vue)`, `tradeSetup.js`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `classifyAge()` connect `tradeEvidence.ts` to `pricePrecisionForInstrument`, `backfillTradeSetupOutcomes.ts`, `PriceChart.vue`, `liquidity.js`?**
