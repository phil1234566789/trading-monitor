...
## Corpus Check
- 492 files · ~499,791 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3050 nodes · 6211 edges · 157 communities (138 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 110 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9ae90412`
...
Cohesion: 0.13
Nodes (29): isBoxInvalidated(), detectSetupObs(), fetchDealingRangeCockpit(), findRecentTradeSetupIdsByKey(), getForexCandlesArchive(), getJournal(), getTradeSetups(), getTradingAccounts() (+21 more)
...
### Community 7 - "db.ts"
Cohesion: 0.08
Nodes (37): addPinEntry(), addPinM5LiquidityEntry(), addPinM5ObEntry(), addPinRsiDivergenceEntry(), addTradeConfirmation(), AddTradeConfirmationArgs, addTradeTarget(), AddTradeTargetArgs (+29 more)
...
Cohesion: 0.06
Nodes (24): refreshMarketStructure(), Candle, ArrowPaneView, ArrowPrimitive, ArrowRenderer, collectFibLevels(), collectNestedChain(), computeFibLevels() (+16 more)
...
Cohesion: 0.21
Nodes (17): deriveStepAndCase(), LoadedMachine, loadMachineForDayOrNull(), loadOrCreateMachineForDay(), rehydrateActor(), safeTransitionChain(), createTradingActor(), currentNodePath() (+9 more)
...
Cohesion: 0.06
Nodes (65): AgeTier, updateTradePosition(), assessInducement(), checkFallFour(), CheckFallFourInput, computeHtfWatchLevels(), computeWatchLevels(), FallFourResult (+57 more)
...
### Community 51 - "OrderBlockPrimitive"
Cohesion: 0.13
Nodes (4): OrderBlockPrimitive, ZonePaneView, ZoneRenderer, obPrimitiveAt()

### Community 52 - "usePriceChartLiquidity.js"
Cohesion: 0.15
Nodes (23): refresh(), liquidityLevelNaturalKey(), renderLiquidityLevels(), buildLevel(), detectLiquidityLevels(), filterRelevantLevels(), isDownFractal(), isUpFractal() (+15 more)
...
### Community 62 - "berlinDateTimeStrFor"
Cohesion: 0.08
Nodes (41): berlinDateTimeStrFor(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, deleteDealingRange(), buildServer(), MCP_TOKEN, berlinTwinKey() (+33 more)
...
### Community 73 - "berlinDateStrFor"
Cohesion: 0.21
Nodes (20): berlinDateStrFor(), fetchActiveTscRangeId(), getOpenOppositeDealingRanges(), computeEvidenceScore(), EvidenceScoreBreakdownEntry, EvidenceScoreInput, EvidenceScoreResult, loadMachineForDay() (+12 more)
...
### Community 86 - "marketStructureAnalysis Rules Overview"
Cohesion: 0.22
...
Cohesion: 0.18
Nodes (10): readForexCandlesArchiveFrom(), DEFAULT_TRADE_SETUP_PARAMS, TRADE_SETUP_H1_FRACTAL_PERIOD, TRADE_SETUP_M5_FRACTAL_PERIOD, alarmFenster, Candle, [fensterVon, fensterBis], instrumente (+2 more)
...
Cohesion: 0.12
Nodes (22): getLatestDailyStructureStartTime(), Candle, computeRangesPivots(), pivotForDisplay(), summarizeMarketStructureState(), buildDataExport(), capStructurePivots(), coincidesWithHtf() (+14 more)
...
### Community 95 - "findTargetCandidates.js"
Cohesion: 0.15
Nodes (20): buildLevel(), detectLiquidityLevels(), filterRelevantLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_FRACTAL_PERIOD, LIQUIDITY_MAX_RELEVANT, LiquidityLevel (+12 more)
...
Cohesion: 0.07
Nodes (41): ev(), Erwartungswert in R ueber die ENTSCHIEDENEN DRs (Treffer oder Stopp, nicht…, handelsstunden(), lade_bekannte_level(), lade_kerzen(), lade_setups(), lade_trend(), lauf() (+33 more)
...
### Community 101 - "backfillLiquidityLevels.ts"
Cohesion: 0.27
...
Cohesion: 0.08
Nodes (24): cssColor(), cssColorScaled(), hexToRgba(), usePriceChartTradeSetupDrawing(), refresh(), toPips(), TRADE_SETUP_OB_BORDER_RATIO, TRADE_SETUP_OB_FILL_RATIO (+16 more)
...
Cohesion: 0.24
Nodes (16): fetchExportCandles(), DB_ARCHIVED_BARS, fetchArchivedPage(), fetchArchivedUpTo(), fetchCandles(), fetchCandlesBatchOnce(), fetchCandlesOnce(), fetchInitialCandles() (+8 more)

### Community 121 - "fetchForexCandles"
Cohesion: 0.13
Nodes (22): fetchAllRows(), getForexCandlesArchiveUpTo(), getObZones(), fetchForexCandles(), fetchLiveForexCandles(), fetchLiveForexCandlesOnce(), isRetryable(), ALL_BARS (+14 more)

### Community 122 - "marketStructureAnalysis.test.js"
Cohesion: 0.22
Nodes (8): pivot1, pivot2, pivot3, pivot4, pivot5, pivot6, pivot7, pivot8

### Community 124 - "usePriceChartRsi.js"
Cohesion: 0.22
...
### Community 131 - "recentReactions.ts"
Cohesion: 0.19
Nodes (20): berlinOffsetMinutes(), getLiquidityLevels(), getSessions(), PIP_SIZE, ALL_DAYS, attachRangeExtremes(), bonusLabelForPivot(), buildSessionContextLookup() (+12 more)
...
### Community 144 - "usePriceChartLiquidity"
Cohesion: 0.40
...
### Community 153 - "trendChainLevelDisplay"
Cohesion: 0.50
...
## Knowledge Gaps
- **1129 isolated node(s):** `{ execFileSync }`, `path`, `TRADING_REPO`, `{ execFileSync }`, `path` (+1124 more)
...
- **Why does `businessSecondsBetween()` connect `_shared/ageTier.ts` to `dealingRangeLoop.ts`, `dataExport.ts`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `marketStructureAnalysis Developer Notes` connect `Vegapunk Slimming Results (-86%)` to `fachdoku-router/SKILL.md`, `marketStructureAnalysis Rules Overview`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `businessSecondsBetween()` connect `liquidity.js` to `clipReplay`, `_shared/ageTier.ts`, `PriceChart.vue`, `tradeSetupCockpit.ts`?**
