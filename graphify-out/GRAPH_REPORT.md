...
## Corpus Check
- 569 files · ~613,620 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3353 nodes · 6777 edges · 181 communities (157 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 117 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0c9a71f9`
...
Cohesion: 0.01
Nodes (135): useSessionStorageRef(), useTabScopedRef(), addPositionToDealingRange(), antiConfluenceAddTrade, anyArmStateActive, ARM_HINTS, ARM_STATES, armedAction (+127 more)
...
Cohesion: 0.14
Nodes (17): cachedCandlesUpTo(), cacheKey(), fetchCandlesCached(), getCachedCandles(), hasLargeCandleGap(), openDb(), safeCompleteUpTo(), setCachedCandles() (+9 more)

### Community 3 - "berlinDateStrFor"
Cohesion: 0.07
Nodes (62): berlinDateStrFor(), berlinDateTimeStrFor(), DATE_FORMATTER, OFFSET_FORMATTER, TIME_FORMATTER, isBoxInvalidated(), toPips(), detectSetupObs() (+54 more)

### Community 4 - "PriceChart.vue"
Cohesion: 0.03
Nodes (77): mergeRecent(), activeMetadataSnapshot, allCandles, antiConfluencePickerCurrentPrice, antiConfluencePickerDivergenceCandidates, antiConfluencePickerHoveredLiquidityKey, antiConfluencePickerHoveredObKey, antiConfluencePickerInvalidationObCandidates (+69 more)
...
Cohesion: 0.11
Nodes (29): buildLevel(), detectLiquidityLevels(), filterRelevantLevels(), isDownFractal(), isUpFractal(), LIQUIDITY_MAX_RELEVANT, LiquidityLevel, buildPendingDecisions() (+21 more)
...
Cohesion: 0.05
Nodes (62): MAJOR_MIN_SECONDS, MINOR_MAX_SECONDS, businessSecondsBetween(), classifyAge(), computeSweepAgeHours(), MAJOR_MIN_HOURS, MAJOR_MIN_SECONDS, MINOR_MAX_HOURS (+54 more)
...
Cohesion: 0.11
Nodes (19): DB_READ_PAGE_SIZE, fetchAllRows(), ArchivableCandle, LIQUIDITY_FRACTAL_PERIOD, backfillOne(), BAR_CONFIG, BARS, CandleRow (+11 more)
...
### Community 35 - "cssColor"
Cohesion: 0.11
Nodes (12): cssColor(), cssColorScaled(), hexToRgba(), lineWidth(), rowStyle(), refreshDivergence(), usePriceChartTradeSetupDrawing(), refresh() (+4 more)
...
Cohesion: 0.16
Nodes (28): tradesVisibleForCandles(), applyCandleData(), buildActiveMetadataSnapshotInternal(), clipReplay(), computeTradeSetupsInternal(), loadTradeSetupM5(), obZoneCtx(), refreshChart() (+20 more)
...
Cohesion: 0.12
Nodes (16): ANNOTATION_COLOR, annotationAnchorPoint(), AnnotationsRenderer, parseAnnotations(), resolveLabelPlacements(), resolveTime(), VALID_TYPES, validateAnnotationList() (+8 more)
...
Cohesion: 0.31
Nodes (16): advanceNestedTrend(), applyInnerMarketStructurePivotCore(), applyMarketStructurePivotCore(), closesAboveOldHigh(), closesBelowLevel(), deriveTrendReaction(), evaluateConfirmingBreak(), invalidateDowntrend() (+8 more)
...
### Community 59 - "machineState.ts"
Cohesion: 0.09
Nodes (39): BERLIN_HM_FORMATTER, BERLIN_WEEKDAY_FORMATTER, berlinWeekdayAndMinutes(), isWithinTradingWindows(), TradingWindows, WeekdayGroup, getNewsEvents(), getTradingSchedule() (+31 more)

### Community 60 - "db.ts"
Cohesion: 0.05
Nodes (70): addPinEntry(), addPinM5LiquidityEntry(), addPinM5ObEntry(), addPinRsiDivergenceEntry(), addTradeConfirmation(), AddTradeConfirmationArgs, addTradePosition(), addTradeTarget() (+62 more)

### Community 61 - "liquidity.js"
Cohesion: 0.11
Nodes (31): usePriceChartLiquidity(), attachBonus(), refresh(), bullBearLabelSide(), formatLiquidityLevelLabel(), levelOptions(), LIQUIDITY_STYLE_KEYS, liquidityLevelNaturalKey() (+23 more)
...
### Community 79 - "runtimeCopySyncGuard.test.js"
Cohesion: 0.33
...
Cohesion: 0.15
Nodes (23): berlinDayRangeUtcMs(), getForexCandlesArchive(), getJournal(), getObZones(), getTradeSetups(), getTradingAccounts(), computeEma(), DayWindow (+15 more)
...
Cohesion: 0.06
Nodes (25): refreshMarketStructure(), Candle, collectNestedChain(), ArrowPaneView, ArrowPrimitive, ArrowRenderer, collectFibLevels(), collectStructureLqLevels() (+17 more)

### Community 93 - "dataExport.ts"
Cohesion: 0.07
Nodes (54): berlinOffsetMinutes(), berlinOffsetFromSec(), forbiddenSessionAt(), SessionDangerConfig, PIP_SIZE, ALL_DAYS, attachRangeExtremes(), bonusLabelForPivot() (+46 more)
...
### Community 119 - "chartTimeUtils.test.js"
Cohesion: 0.15
Nodes (12): computeNextReplayTime(), nextCandleAfter(), replayFetchToMs(), loadInitial(), loadRangesCandles(), nextReplayTime(), replayToMs(), scheduleNextRangesPoll() (+4 more)
...
Cohesion: 0.29
Nodes (7): Datenprüfung, Ergebnis und Umfang, Handelspausen, Nachkontrolle und Artefakte, Noch offen für vollständige Anbindung, XAUUSD: begrenzter FXCM-H1-Kontotest, 24.09.2026, Übertragung der Preisabstände: Vorschlag, nicht aktiviert
...
Cohesion: 0.13
Nodes (24): AgeTier, classifyAge(), ageReferenceTime(), businessSecondsBetween(), formatAge(), targetLabel(), targetLabel(), ageSuffix() (+16 more)

### Community 141 - "fmtPrice"
Cohesion: 0.06
Nodes (42): candidateLabel(), candidatePrice(), emit, mergedCandidates, precision, props, marketStructureTree, emit (+34 more)
...
### Community 159 - "debugMetadata.js"
Cohesion: 0.39
...
### Community 168 - "buildMarketStructureState"
Cohesion: 0.50
Nodes (5): buildMarketStructureState(), computeRangesPivots(), effectiveTrend(), buildStructureWithPhases(), run()
...
### Community 174 - "evidenceScoring.ts"
Cohesion: 0.40
...
### Community 176 - "marketStructureAnalysisDowntrendChoch.test.js"
Cohesion: 0.33
...
## Knowledge Gaps
- **1223 isolated node(s):** `{ readFileSync }`, `{ join }`, `SKILL`, `{ execFileSync }`, `path` (+1218 more)
...
- **Why does `renderMarketStructureAnalysis()` connect `marketStructureRendering.ts` to `usePriceChartMarketStructure.js`, `cssColor`, `businessSecondsBetween`, `fmtPrice`, `Vegapunk Slimming Results (-86%)`, `LiquidityLinePrimitive`, `liquidity.js`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `businessSecondsBetween()` connect `rsiDivergenceStats.ts` to `tradeSetup.ts`, `dataExport.ts`, `dealingRangeLoop.ts`?**
...
- **Should `Dashboard.vue` be split into smaller, more focused modules?**
  _Cohesion score 0.014420460729185562 - nodes in this community are weakly interconnected._
