...
## Corpus Check
- 464 files · ~454,962 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2937 nodes · 6045 edges · 145 communities (127 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 109 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a1a8e980`
...
Cohesion: 0.14
Nodes (28): inducementAgeRange(), isBoxInvalidated(), detectSetupObs(), berlinDayRangeUtcMs(), findRecentTradeSetupIdsByKey(), getForexCandlesArchive(), getJournal(), getTradeSetups() (+20 more)
...
### Community 7 - "db.ts"
Cohesion: 0.06
Nodes (59): InducementClass, addPinEntry(), addPinM5LiquidityEntry(), addPinM5ObEntry(), addPinRsiDivergenceEntry(), addTradeConfirmation(), AddTradeConfirmationArgs, addTradePosition() (+51 more)
...
Cohesion: 0.12
Nodes (18): emit, instrumentSessions, props, WEEKDAY_DISPLAY_ORDER, refreshSessions(), ALL_DAYS, addSession(), currentSessionDanger() (+10 more)
...
Cohesion: 0.15
Nodes (22): marketStructureTree, berlinOffsetMinutes(), buildDataExport(), compute1hStructureState(), computeExportTimeframeData(), computeLiquidityLevelsForExport(), computeObZonesForExport(), DATE_FORMATTER (+14 more)
...
Cohesion: 0.06
Nodes (55): AgeTier, classifyAge(), MAJOR_MIN_SECONDS, MINOR_MAX_SECONDS, ageReferenceTime(), businessSecondsBetween(), formatAge(), confirmationLabel() (+47 more)
...
Cohesion: 0.33
Nodes (4): buildMarketStructureState(), computeRangesPivots(), RANGES_CANDLE_BUFFER, BASE_CTX
...
### Community 82 - "applyInnerMarketStructurePivot"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (68): filterRelevantLevels(), LIQUIDITY_MAX_RELEVANT, berlinOffsetMinutes(), asOfProbeCandles(), dropLowerTfDuplicates(), fetchAllRows(), filterRelevantRows(), getForexCandlesArchiveUpTo() (+60 more)
...
### Community 103 - "marketStructureAnalysis Rules Overview"
Cohesion: 0.06
...
### Community 119 - "usePriceChartMarketStructure"
Cohesion: 0.33
...
### Community 121 - "usePriceChartDailyPivots"
Cohesion: 0.40
...
### Community 124 - "marketStructureAnalysisFib.test.js"
Cohesion: 0.33
