...
export interface Zone {
  ...
  // Heisst fvg und nicht gap, obwohl die Rechnung darunter bullGap/bearGap sagt: "Gap" meint im
  // Trading auch das Wochenend-Gap, und persistiert wird das hier als ob_fvg.
  fvg: number;
  active: boolean;
  touched: boolean;
  invalidated: boolean;
